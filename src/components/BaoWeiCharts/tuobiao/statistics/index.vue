    ...
    >
      <div class="statisticsBox">
        <div class="statistics_title">
          <i
            v-if="statisticsAll.parentModuleId"
            @click="statisticsClose"
            class="el-icon-close"
          ></i>
          <div class="box theme-border-color">
            ...
            <div class="right">
              ...
              <el-popconfirm
                ...
                v-if="isAdmin"
              >
                <i title="删除" slot="reference" class="el-icon-delete"></i>
              </el-popconfirm>
              <i
                title="筛选配置"
                v-if="isAdmin"
              ...
              <i
                ...
                "
                @click="filterShow"
                class="iconshaixuan iconfont theme-color"
              ></i>
              <div class="pic" v-if="isAdmin && typeData.length > 1">
        ...
        >
          ...
          <!-- 数据表格展示 -->
          <bw-table
            v-if="settingForm.displayMode == 'table'"
          ...
          <!-- 折线图、条形图、柱状图、饼图、环图 -->
          <bw-line
            v-if="bwLineType.indexOf(settingForm.displayMode) > -1"
            :data="statisticsAll.data"
          ...
          <div class="suofang" v-if="isAdmin">
            <i
              @mousedown="mousedown_ls"
              class="iconfont iconkuozhan theme-color"
            ></i>
          </div>
        </div>
        ...
        ></settingForm>
        <!-- 筛选配置弹出层 -->
        <screen ref="screenSetting" @screenKeep="screenKeep"></screen>
      </div>
    </article>
  </div>
</template>
