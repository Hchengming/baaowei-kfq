 <template>
  ...
  >
    <el-form ref="form" :model="menuFormAll.menuForm" :rules="rules" label-width="130px">
      <el-form-item label="菜单编码" prop="menuCode">
        <el-input size="small" v-model="menuFormAll.menuForm.menuCode"></el-input>
      </el-form-item>
      <el-form-item label="菜单名称" prop="menuName">
        <el-input size="small" v-model="menuFormAll.menuForm.menuName"></el-input>
      </el-form-item>
       <el-form-item label="菜单图标" prop="menuIcon">
        <el-input size="small" v-model="menuFormAll.menuForm.menuIcon"></el-input>
      </el-form-item>
    </el-form>
