    ...
    >
      <el-form ref="form" :model="form" label-width="130px">
        <el-row type="flex" class="row-bg">
          ...
          <el-col :span="12">
            <el-form-item label="副标题1">
              <el-input size="small" :disabled="form.mask?true:false" v-model="form.subtitle1"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="副标题2">
              <el-input size="small" v-model="form.subtitle2"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="数据展现方式">
              <el-select v-model="form.displayMode" size="small" placeholder="请选择">
                <el-option
        ...
        <el-row type="flex" class="row-bg">
          ...
          <el-col :span="12">
            <el-form-item v-if="form.submodule=='1'" label="子模块点击展现">
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="18">
            <el-form-item label="接口">
              <el-input size="small" v-model="form.url" placeholder="接口路径(不含公共部分)"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-button size="small" style="margin-top:2px" @click="getKeysData">字段获取</el-button>
          </el-col>
        </el-row>

        <el-form-item label="字段配置" class="zdpz_box">
          <p class="tips" v-if="!isWidth">*第一个字段必须为图表标题字段</p>
          <ul class="zdpz_list">
            <li class="zdpz_list_header">
              <span class="hTxt1 hTxt">字段名</span>
              <span class="hTxt2 hTxt">含义</span>
              <span class="hTxt3 hTxt" v-if="isWidth">宽度</span>
            ...
            <li v-for="(item,index) in form.keyArr" :key="index" class="zdpz">
              <label class="hTxt1 hTxt">
                <el-input size="mini" placeholder="字段名" v-model="item.key"></el-input>
              </label>
              <label class="hTxt2 hTxt">
                <el-input size="mini" placeholder="含义" v-model="item.explain"></el-input>
              </label>
              <label class="hTxt3 hTxt" v-if="isWidth">
                <el-input size="mini" placeholder="宽度" v-model="item.width"></el-input>
              </label>
              <label class="hTxt4 hTxt">
                <el-input size="mini" placeholder="单位" v-model="item.dw"></el-input>
              </label>
              ...
              <div class="icons hTxt6 hTxt">
                <i @click="keyAdd(index)" class="el-icon-circle-plus-outline  theme-color"></i>
                <i
                  v-show="form.keyArr.length>1"
                ...
                <i
                  ...
                  :class="['iconfont','iconxiayi',{'disabled':form.keyArr.length-1==index}]"
                ></i>
              </div>
            </li>
          </ul>
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="宽度(页面占比)">
              <el-input-number size="small" v-model="form.width" :min="0" :max="100" :precision="2"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="位置X轴(页面占比)">
              <el-input-number size="small" v-model="form.left" :min="0" :max="100" :precision="2"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="位置Y轴(页面占比)">
              <el-input-number size="small" v-model="form.top" :min="0" :max="100" :precision="2"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="层级">
              <el-input v-model="form.zindex" size="small" placeholder="若模块重叠,低层级模块会被高层级覆盖"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.isPage=='1'" label="每页显示数据(条)">
              <el-input-number
                size="small"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.mask" label="是否添加遮罩层">
