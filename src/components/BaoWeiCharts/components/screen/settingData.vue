  ...
  <div>
    ...
    >
      <el-form ref="form">
        <el-form-item label="数据源" label-width="65px">
          <el-radio-group v-model="dataType">
            <el-radio :disabled="customDisabled" label="custom">自定义</el-radio>
            <el-radio label="dataUrl">接口数据</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item v-if="dataType=='dataUrl'" label="数据接口" label-width="65px">
          <el-input v-model="dataUrl" size="small"></el-input>
        </el-form-item>
        <div v-if="dataType=='custom'">
          <el-row type="flex" class="row-bg" v-for="(item,index) in settingData" :key="index">
            <el-col :span="10">
            ...
            <el-col :span="4">
              <div class="rightIcon">
                ...
                ></i>
                <i
                  @click="sortNext(item,index,settingData.length-1==index)"
                  :class="['iconfont','iconxiayi',{'disabled':settingData.length-1==index}]"
                ></i>
      ...
      <span slot="footer" class="dialog-footer">
        <div>
          <el-button @click="addData" type="primary">新 增</el-button>
        </div>
        <div class="right">
