...
! function (e, t) {
    ...
    function g(e) {
        var t = !!e && "length" in e && e.length,
            i = A.type(e);
        return "function" !== i && !A.isWindow(e) && ("array" === i || 0 === t || "number" == typeof t && 0 < t && t - 1 in e)
    }
    A.fn = A.prototype = {
        jquery: e,
        constructor: A,
        ...
        var e, t, i, n, o, r, s = arguments[0] || {},
            ...
            l = arguments.length,
            d = !1;
        for ("boolean" == typeof s && (d = s, s = arguments[a] || {}, a++), "object" == typeof s || A.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (o = arguments[a]))
                for (n in o) e = s[n], s !== (i = o[n]) && (d && i && (A.isPlainObject(i) || (t = A.isArray(i))) ? (r = t ? (t = !1, e && A.isArray(e) ? e : []) : e && A.isPlainObject(e) ? e : {}, s[n] = A.extend(d, r, i)) : void 0 !== i && (s[n] = i));
        return s
    }, A.extend({
        ...
        isNumeric: function (e) {
            var t = e && e.toString();
            return !A.isArray(e) && 0 <= t - parseFloat(t) + 1
        },
        ...
        globalEval: function (e) {
            e && A.trim(e) && (_.execScript || function (e) {
                _.eval.call(_, e)
            })(e)
        },
        ...
        makeArray: function (e, t) {
            var i = t || [];
            return null != e && (g(Object(e)) ? A.merge(i, "string" == typeof e ? [e] : e) : a.call(i, e)), i
        },
        ...
        proxy: function (e, t) {
            var i, n, o;
            return "string" == typeof t && (o = e[t], t = e, e = o), A.isFunction(e) ? (i = h.call(arguments, 2), (n = function () {
                return e.apply(t || this, i.concat(h.call(arguments)))
            }).guid = e.guid = e.guid || A.guid++ , n) : void 0
        },
        now: function () {
            return +new Date
        },
        support: C
    }), "function" == typeof Symbol && (A.fn[Symbol.iterator] = c[Symbol.iterator]), A.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (e, t) {
        i["[object " + t + "]"] = t.toLowerCase()
    });
    var u = function (i) {
        var e, f, w, r, o, m, c, v, x, l, d, b, D, s, k, g, a, h, y, _ = "sizzle" + 1 * new Date,
            $ = i.document,
            C = 0,
            n = 0,
            A = oe(),
        ...
        function ne(e, t, i, n) {
            var o, r, s, a, l, d, h, c, u = t && t.ownerDocument,
                p = t ? t.nodeType : 9;
            if (i = i || [], "string" != typeof e || !e || 1 !== p && 9 !== p && 11 !== p) return i;
            if (!n && ((t ? t.ownerDocument || t : $) !== D && b(t), t = t || D, k)) {
                if (11 !== p && (d = Y.exec(e)))
                    if (o = d[1]) {
                        if (9 === p) {
                ...
                if (f.qsa && !T[e + " "] && (!g || !g.test(e))) {
                    if (1 !== p) u = t, c = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(Z, "\\$&") : t.setAttribute("id", a = _), r = (h = m(e)).length, l = V.test(a) ? "#" + a : "[id='" + a + "']"; r--;) h[r] = l + " " + fe(h[r]);
        ...
        for (e in f = ne.support = {}, o = ne.isXML = function (e) {
            ...
            return n !== D && 9 === n.nodeType && n.documentElement && (s = (D = n).documentElement, k = !o(D), (i = D.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", ie, !1) : i.attachEvent && i.attachEvent("onunload", ie)), f.attributes = se(function (e) {
                ...
                return s.appendChild(e).id = _, !D.getElementsByName || !D.getElementsByName(_).length
            ...
            if ((e.ownerDocument || e) !== D && b(e), t = t.replace(P, "='$1']"), f.matchesSelector && k && !T[t + " "] && (!a || !a.test(t)) && (!g || !g.test(t))) try {
                var i = h.call(e, t);
            ...
            var i = w.attrHandle[t.toLowerCase()],
                n = i && N.call(w.attrHandle, t.toLowerCase()) ? i(e, t, !k) : void 0;
            ...
            filter: {
                ...
                ATTR: function (i, n, o) {
                    return function (e) {
                        var t = ne.attr(e, i);
                        return null == t ? "!=" === n : !n || (t += "", "=" === n ? t === o : "!=" === n ? t !== o : "^=" === n ? o && 0 === t.indexOf(o) : "*=" === n ? o && -1 < t.indexOf(o) : "$=" === n ? o && t.slice(-o.length) === o : "~=" === n ? -1 < (" " + t.replace(G, " ") + " ").indexOf(o) : "|=" === n && (t === o || t.slice(0, o.length + 1) === o + "-"))
                    }
                },
                CHILD: function (f, e, t, m, v) {
                    ...
                    return 1 === m && 0 === v ? function (e) {
                        ...
                        var n, o, r, s, a, l, d = g !== y ? "nextSibling" : "previousSibling",
                            h = e.parentNode,
                        ...
                        if (h) {
                            if (g) {
                                for (; d;) {
                                    for (s = e; s = s[d];)
                                        if ($ ? s.nodeName.toLowerCase() === c : 1 === s.nodeType) return !1;
                                    l = d = "only" === f && !l && "nextSibling"
                                }
                                return !0
                            }
                            if (l = [y ? h.firstChild : h.lastChild], y && u) {
                                for (p = (a = (n = (o = (r = (s = h)[_] || (s[_] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] || [])[0] === C && n[1]) && n[2], s = a && h.childNodes[a]; s = ++a && s && s[d] || (p = a = 0) || l.pop();)
                                    if (1 === s.nodeType && ++p && s === e) {
                                        o[f] = [C, a, p];
                                        break
                                    }
                            } else if (u && (p = a = (n = (o = (r = (s = e)[_] || (s[_] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] || [])[0] === C && n[1]), !1 === p)
                                for (;
                                    (s = ++a && s && s[d] || (p = a = 0) || l.pop()) && (($ ? s.nodeName.toLowerCase() !== c : 1 !== s.nodeType) || !++p || (u && ((o = (r = s[_] || (s[_] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] = [C, p]), s !== e)););
            ...
            pseudos: {
                not: re(function (e) {
                    var n = [],
                        o = [],
                        a = c(e.replace(q, "$1"));
                    return a[_] ? re(function (e, t, i, n) {
        ...
        function me(a, e, t) {
            ...
            return e.first ? function (e, t, i) {
                ...
                if (i) {
                    ...
                    for (; e = e[l];)
                        if (1 === e.nodeType || d) {
                            if ((n = (o = (r = e[_] || (e[_] = {}))[e.uniqueID] || (r[e.uniqueID] = {}))[l]) && n[0] === C && n[1] === h) return s[2] = n[2];
        ...
        function ye(f, m, v, g, y, e) {
            return g && !g[_] && (g = ye(g)), y && !y[_] && (y = ye(y, e)), re(function (e, t, i, n) {
                var o, r, s, a = [],
                    l = [],
                    d = t.length,
                    h = e || function p(e, t, i) {
                        for (var n = 0, o = t.length; n < o; n++) ne(e, t[n], i);
                        return i
                    }(m || "*", i.nodeType ? [i] : i, []),
                    c = !f || !e && m ? h : ge(h, a, f, i, n),
                    u = v ? y || (e ? f : d || g) ? [] : t : c;
                if (v && v(c, u, i, n), g)
                    for (o = ge(u, l), g(o, [], i, n), r = o.length; r--;)(s = o[r]) && (u[l[r]] = !(c[l[r]] = s));
                if (e) {
                    if (y || f) {
                        if (y) {
        ...
        function $e(e) {
            for (var o, t, i, n = e.length, r = w.relative[e[0].type], s = r || w.relative[" "], a = r ? 1 : 0, l = me(function (e) {
                ...
                if (t = w.relative[e[a].type]) h = [me(ve(h), t)];
                else {
                    if ((t = w.filter[e[a].type].apply(null, e[a].matches))[_]) {
                        for (i = ++a; i < n && !w.relative[e[i].type]; i++);
                        return ye(1 < a && ve(h), 1 < a && fe(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(q, "$1"), t, a < i && $e(e.slice(a, i)), i < n && $e(e = e.slice(i)), i < n && fe(e))
                    }
                    h.push(t)
                }
            return ve(h)
        ...
        return pe.prototype = w.filters = w.pseudos, w.setFilters = new pe, m = ne.tokenize = function (e, t) {
            ...
            for (s = e, a = [], l = w.preFilter; s;) {
                for (r in i && !(n = z.exec(s)) || (n && (s = s.slice(n[0].length) || s), a.push(o = [])), i = !1, (n = R.exec(s)) && (i = n.shift(), o.push({
                    value: i,
                    type: n[0].replace(q, " ")
            ...
            var i, n = [],
                ...
                r = T[e + " "];
            if (!r) {
                for (t || (t = m(e)), i = t.length; i--;)(r = $e(t[i]))[_] ? n.push(r) : o.push(r);
                (r = T(e, function s(v, g) {
                    var y = 0 < g.length,
                        $ = 0 < v.length,
                        e = function (e, t, i, n, o) {
                            ...
                            for (o && (x = t === D || t || o); d !== m && null != (r = p[d]); d++) {
                                if ($ && r) {
                                    for (s = 0, t || r.ownerDocument === D || (b(r), i = !k); a = v[s++];)
                                        if (a(r, t || D, i)) {
                                            n.push(r);
                                            break
                                        }
            ...
            var o, r, s, a, l, d = "function" == typeof e && e,
                h = !n && m(e = d.selector || e);
            if (i = i || [], 1 === h.length) {
                if (2 < (r = h[0] = h[0].slice(0)).length && "ID" === (s = r[0]).type && f.getById && 9 === t.nodeType && k && w.relative[r[1].type]) {
                ...
                for (o = X.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !w.relative[a = s.type]);)
                    if ((l = w.find[a]) && (n = l(s.matches[0].replace(ee, te), Q.test(r[0].type) && ue(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = n.length && fe(r))) return M.apply(i, n), i;
                        break
                    }
            }
            return (d || c(e, h))(n, t, !k, i, !t || Q.test(e) && ue(t.parentNode) || t), i
        }, f.sortStable = _.split("").sort(p).join("") === _, f.detectDuplicates = !!d, b(), f.sortDetached = se(function (e) {
    ...
    A.find = u, A.expr = u.selectors, A.expr[":"] = A.expr.pseudos, A.uniqueSort = A.unique = u.uniqueSort, A.text = u.getText, A.isXMLDoc = u.isXML, A.contains = u.contains;
    ...
    function x(e, i, n) {
        if (A.isFunction(i)) return A.grep(e, function (e, t) {
            return !!i.call(e, t, e) !== n
        });
        if (i.nodeType) return A.grep(e, function (e) {
            return e === i !== n
        });
        if ("string" == typeof i) {
            if (w.test(i)) return A.filter(i, e, n);
            i = A.filter(i, e)
        }
        return A.grep(e, function (e) {
            return -1 < A.inArray(e, i) !== n
        })
    }
    A.filter = function (e, t, i) {
        ...
        find: function (e) {
            ...
            if ("string" != typeof e) return this.pushStack(A(e).filter(function () {
                for (t = 0; t < o; t++)
                    if (A.contains(n[t], this)) return !0
            }));
            for (t = 0; t < o; t++) A.find(e, n[t], i);
            return (i = this.pushStack(1 < o ? A.unique(i) : i)).selector = this.selector ? this.selector + " " + e : e, i
        },
        filter: function (e) {
        ...
        is: function (e) {
            return !!x(this, "string" == typeof e && $.test(e) ? A(e) : e || [], !1).length
        }
    });
    var b, D = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (A.fn.init = function (e, t, i) {
        var n, o;
        if (!e) return this;
        if (i = i || b, "string" != typeof e) return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : A.isFunction(e) ? "undefined" != typeof i.ready ? i.ready(e) : e(A) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), A.makeArray(e, this));
        ...
        if (n[1]) {
            if (t = t instanceof A ? t[0] : t, A.merge(this, A.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : f, !0)), T.test(n[1]) && A.isPlainObject(t))
                for (n in t) A.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
            return this
        }
    ...
    A.fn.extend({
        ...
        closest: function (e, t) {
            for (var i, n = 0, o = this.length, r = [], s = $.test(e) || "string" != typeof e ? A(e, t || this.context) : 0; n < o; n++)
                for (i = this[n]; i && i !== t; i = i.parentNode)
                    if (i.nodeType < 11 && (s ? -1 < s.index(i) : 1 === i.nodeType && A.find.matchesSelector(i, e))) {
                        r.push(i);
                        break
                    }
        ...
        index: function (e) {
            return e ? "string" == typeof e ? A.inArray(this[0], A(e)) : A.inArray(e.jquery ? e[0] : e, this) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        },
        add: function (e, t) {
        ...
        contents: function (e) {
            return A.nodeName(e, "iframe") ? e.contentDocument || e.contentWindow.document : A.merge([], e.childNodes)
        }
    }, function (n, o) {
        A.fn[n] = function (e, t) {
            var i = A.map(this, o, e);
            return "Until" !== n.slice(-5) && (t = e), t && "string" == typeof t && (i = A.filter(t, i)), 1 < this.length && (N[n] || (i = A.uniqueSort(i)), k.test(n) && (i = i.reverse())), this.pushStack(i)
        }
    });
    var E, M, L = /\S+/g;

    function F() {
        f.addEventListener ? (f.removeEventListener("DOMContentLoaded", I), _.removeEventListener("load", I)) : (f.detachEvent("onreadystatechange", I), _.detachEvent("onload", I))
    }

    function I() {
        (f.addEventListener || "load" === _.event.type || "complete" === f.readyState) && (F(), A.ready())
    }
    for (M in A.Callbacks = function (n) {
        n = "string" == typeof n ? function h(e) {
            var i = {};
            return A.each(e.match(L) || [], function (e, t) {
                i[t] = !0
            }), i
        }(n) : A.extend({}, n);
        var o, e, t, i, r = [],
            ...
            a = -1,
            l = function () {
                for (i = n.once, t = o = !0; s.length; a = -1)
                    for (e = s.shift(); ++a < r.length;)!1 === r[a].apply(e[0], e[1]) && n.stopOnFalse && (a = r.length, e = !1);
                ...
                add: function () {
                    return r && (e && !o && (a = r.length - 1, s.push(e)), function i(e) {
                        A.each(e, function (e, t) {
                            A.isFunction(t) ? n.unique && d.has(t) || r.push(t) : t && t.length && "string" !== A.type(t) && i(t)
                        })
                    }(arguments), e && !o && l()), this
                },
                remove: function () {
                    return A.each(arguments, function (e, t) {
                        for (var i; - 1 < (i = A.inArray(t, r, i));) r.splice(i, 1), i <= a && a--
                    }), this
                },
                has: function (e) {
                    return e ? -1 < A.inArray(e, r) : 0 < r.length
                },
                empty: function () {
                    return r && (r = []), this
                },
                        ...
                        return A.Deferred(function (n) {
                            A.each(r, function (e, t) {
                                ...
                                a[t[1]](function () {
                                    ...
                                    e && A.isFunction(e.promise) ? e.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[t[0] + "With"](this === s ? n.promise() : this, i ? [e] : arguments)
                                })
                            }), o = null
                        }).promise()
                    },
                    promise: function (e) {
                        return null != e ? A.extend(e, s) : s
                    }
                },
                a = {};
            return s.pipe = s.then, A.each(r, function (e, t) {
                var i = t[2],
                    n = t[3];
        ...
        when: function (e) {
            var o, t, i, n = 0,
                r = h.call(arguments),
                s = r.length,
                a = 1 !== s || e && A.isFunction(e.promise) ? s : 0,
                l = 1 === a ? e : A.Deferred(),
                d = function (t, i, n) {
                    return function (e) {
            ...
            if (1 < s)
                for (o = new Array(s), t = new Array(s), i = new Array(s); n < s; n++) r[n] && A.isFunction(r[n].promise) ? r[n].promise().progress(d(n, t, o)).done(d(n, i, r)).fail(l.reject) : --a;
            return a || l.resolveWith(i, r), l.promise()
        }
    }), A.fn.ready = function (e) {
        return A.ready.promise().done(e), this
    }, A.extend({
        isReady: !1,
        readyWait: 1,
        ...
        ready: function (e) {
            (!0 === e ? --A.readyWait : A.isReady) || ((A.isReady = !0) !== e && 0 < --A.readyWait || (E.resolveWith(f, [A]), A.fn.triggerHandler && (A(f).triggerHandler("ready"), A(f).off("ready"))))
        }
    }), A.ready.promise = function (e) {
        if (!E)
            if (E = A.Deferred(), "complete" === f.readyState || "loading" !== f.readyState && !f.documentElement.doScroll) _.setTimeout(A.ready);
            else if (f.addEventListener) f.addEventListener("DOMContentLoaded", I), _.addEventListener("load", I);
            else {
                f.attachEvent("onreadystatechange", I), _.attachEvent("onload", I);
                var t = !1;
                try {
                    t = null == _.frameElement && f.documentElement
                } catch (h) { }
        ...
        return E.promise(e)
    }, A.ready.promise(), A(C)) break;
    C.ownFirst = "0" === M, C.inlineBlockNeedsLayout = !1, A(function () {
        var e, t, i, n;
    ...
    function G(e, t, i) {
        if (void 0 === i && 1 === e.nodeType) {
            ...
            if ("string" == typeof (i = e.getAttribute(n))) {
                try {
                    i = "true" === i || "false" !== i && ("null" === i ? null : +i + "" === i ? +i : H.test(i) ? A.parseJSON(i) : i)
                } catch (h) { }
                A.data(e, t, i)
            } else i = void 0
        }
    ...
    function q(e) {
        var t;
        for (t in e)
            if (("data" !== t || !A.isEmptyObject(e[t])) && "toJSON" !== t) return !1;
        return !0
    }
    ...
    function z(e, t, i, n) {
        if (O(e)) {
            var o, r, s = A.expando,
                ...
                l = a ? A.cache : e,
                d = a ? e[s] : e[s] && s;
            if (d && l[d] && (n || l[d].data) || void 0 !== i || "string" != typeof t) return d || (d = a ? e[s] = c.pop() || A.guid++ : s), l[d] || (l[d] = a ? {} : {
                toJSON: A.noop
            }), "object" != typeof t && "function" != typeof t || (n ? l[d] = A.extend(l[d], t) : l[d].data = A.extend(l[d].data, t)), r = l[d], n || (r.data || (r.data = {}), r = r.data), void 0 !== i && (r[A.camelCase(t)] = i), "string" == typeof t ? null == (o = r[t]) && (o = r[A.camelCase(t)]) : o = r, o
        }
    }
    ...
    function R(e, t, i) {
        if (O(e)) {
            var n, o, r = e.nodeType,
                s = r ? A.cache : e,
                a = r ? e[A.expando] : A.expando;
            if (s[a]) {
                if (t && (n = i ? s[a] : s[a].data)) {
                    o = (t = A.isArray(t) ? t.concat(A.map(t, A.camelCase)) : t in n ? [t] : (t = A.camelCase(t)) in n ? [t] : t.split(" ")).length;
                    for (; o--;) delete n[t[o]];
                    if (i ? !q(n) : !A.isEmptyObject(n)) return
                } (i || (delete s[a].data, q(s[a]))) && (r ? A.cleanData([e], !0) : C.deleteExpando || s != s.window ? delete s[a] : s[a] = void 0)
            }
        }
    }
    A.extend({
        ...
        hasData: function (e) {
            return !!(e = e.nodeType ? A.cache[e[A.expando]] : e[A.expando]) && !q(e)
        },
        data: function (e, t, i) {
            return z(e, t, i)
        },
        ...
        data: function (e, t) {
            ...
            if (void 0 !== e) return "object" == typeof e ? this.each(function () {
                ...
                A.data(this, e, t)
            }) : r ? G(r, e, A.data(r, e)) : void 0;
            if (this.length && (o = A.data(r), 1 === r.nodeType && !A._data(r, "parsedAttrs"))) {
                for (i = s.length; i--;) s[i] && (0 === (n = s[i].name).indexOf("data-") && G(r, n = A.camelCase(n.slice(5)), o[n]));
                A._data(r, "parsedAttrs", !0)
            }
            return o
        },
        ...
        queue: function (e, t, i) {
            var n;
            return e ? (t = (t || "fx") + "queue", n = A._data(e, t), i && (!n || A.isArray(i) ? n = A._data(e, t, A.makeArray(i)) : n.push(i)), n || []) : void 0
        },
        ...
        _queueHooks: function (e, t) {
            var i = t + "queueHooks";
            return A._data(e, i) || A._data(e, i, {
                empty: A.Callbacks("once memory").add(function () {
                    A._removeData(e, t + "queue"), A._removeData(e, i)
                })
            })
        }
    }), A.fn.extend({
        queue: function (t, i) {
            var e = 2;
            return "string" != typeof t && (i = t, t = "fx", e--), arguments.length < e ? A.queue(this[0], t) : void 0 === i ? this : this.each(function () {
                var e = A.queue(this, t, i);
        ...
        promise: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(i = A._data(r[s], e + "queueHooks")) && i.empty && (n++ , i.empty.add(a));
            return a(), o.promise(t)
        }
    }), C.shrinkWrapBlocks = function () {
        return null != B ? B : (B = !1, (t = f.getElementsByTagName("body")[0]) && t.style ? (e = f.createElement("div"), (i = f.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", t.appendChild(i).appendChild(e), "undefined" != typeof e.style.zoom && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", e.appendChild(f.createElement("div")).style.width = "5px", B = 3 !== e.offsetWidth), t.removeChild(i), B) : void 0);
        var e, t, i
    };
    var P = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        W = new RegExp("^(?:([+-])=|)(" + P + ")([a-z%]*)$", "i"),
        V = ["Top", "Right", "Bottom", "Left"],
        X = function (e, t) {
            return e = t || e, "none" === A.css(e, "display") || !A.contains(e.ownerDocument, e)
        };
    ...
    function J(e, t, i, n) {
        var o, r = 1,
            ...
            l = a(),
            d = i && i[3] || (A.cssNumber[t] ? "" : "px"),
            h = (A.cssNumber[t] || "px" !== d && +l) && W.exec(A.css(e, t));
        if (h && h[3] !== d)
            for (d = d || h[3], i = i || [], h = +l || 1; h /= r = r || ".5", A.style(e, t, h + d), r !== (r = a() / l) && 1 !== r && --s;);
    ...
    var U, K, Y, Q = function (e, t, i, n, o, r, s) {
        ...
        else if (void 0 !== n && (o = !0, A.isFunction(n) || (s = !0), d && (t = s ? (t.call(e, n), null) : (d = t, function (e, t, i) {
            return d.call(A(e), i)
        })), t))
    ...
    U = f.createElement("div"), K = f.createDocumentFragment(), Y = f.createElement("input"), U.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", C.leadingWhitespace = 3 === U.firstChild.nodeType, C.tbody = !U.getElementsByTagName("tbody").length, C.htmlSerialize = !!U.getElementsByTagName("link").length, C.html5Clone = "<:nav></:nav>" !== f.createElement("nav").cloneNode(!0).outerHTML, Y.type = "checkbox", Y.checked = !0, K.appendChild(Y), C.appendChecked = Y.checked, U.innerHTML = "<textarea>x</textarea>", C.noCloneChecked = !!U.cloneNode(!0).lastChild.defaultValue, K.appendChild(U), (Y = f.createElement("input")).setAttribute("type", "radio"), Y.setAttribute("checked", "checked"), Y.setAttribute("name", "t"), U.appendChild(Y), C.checkClone = U.cloneNode(!0).cloneNode(!0).lastChild.checked, C.noCloneEvent = !!U.addEventListener, U[A.expando] = 1, C.attributes = !U.getAttribute(A.expando);
    var re = {
    ...
    function we(e, t) {
        ...
        if (!r)
            for (r = [], i = e.childNodes || e; null != (n = i[o]); o++)!t || A.nodeName(n, t) ? r.push(n) : A.merge(r, we(n, t));
        return void 0 === t || t && A.nodeName(e, t) ? A.merge([e], r) : r
    }

    function se(e, t) {
        for (var i, n = 0; null != (i = e[n]); n++) A._data(i, "globalEval", !t || A._data(t[n], "globalEval"))
    }
    ...
    function he(e, t, i, n, o) {
        for (var r, s, a, l, d, h, c, u = e.length, p = oe(t), f = [], m = 0; m < u; m++)
            if ((s = e[m]) || 0 === s)
                if ("object" === A.type(s)) A.merge(f, s.nodeType ? [s] : s);
                else if (ae.test(s)) {
                    for (l = l || p.appendChild(t.createElement("div")), d = (ee.exec(s) || ["", ""])[1].toLowerCase(), c = re[d] || re._default, l.innerHTML = c[1] + A.htmlPrefilter(s) + c[2], r = c[0]; r--;) l = l.lastChild;
                    if (!C.leadingWhitespace && ie.test(s) && f.push(t.createTextNode(ie.exec(s)[0])), !C.tbody)
                        for (r = (s = "table" !== d || le.test(s) ? "<table>" !== c[1] || le.test(s) ? 0 : l : l.firstChild) && s.childNodes.length; r--;) A.nodeName(h = s.childNodes[r], "tbody") && !h.childNodes.length && s.removeChild(h);
                    for (A.merge(f, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
                    l = p.lastChild
                } else f.push(t.createTextNode(s));
        for (l && p.removeChild(l), C.appendChecked || A.grep(we(f, "input"), de), m = 0; s = f[m++];)
            if (n && -1 < A.inArray(s, n)) o && o.push(s);
            else if (a = A.contains(s.ownerDocument, s), l = we(p.appendChild(s), "script"), a && se(l), i)
                for (r = 0; s = l[r++];) te.test(s.type || "") && i.push(s);
        return l = null, p
    } ! function () {
        ...
        for (e in {
            ...
            change: !0,
            focusin: !0
        }) t = "on" + e, (C[e] = t in _) || (i.setAttribute(t, "t"), C[e] = !1 === i.attributes[t].expando);
        i = null
    }();
    ...
    function $e(e, t, i, n, o, r) {
        ...
        if (null == n && null == o ? (o = i, n = i = void 0) : null == o && ("string" == typeof i ? (o = n, n = void 0) : (o = n, n = i, i = void 0)), !1 === o) o = ge;
        else if (!o) return e;
        return 1 === r && (s = o, (o = function (e) {
            return A().off(e), s.apply(this, arguments)
        }).guid = s.guid || (s.guid = A.guid++)), e.each(function () {
    ...
    A.event = {
        ...
        add: function (e, t, i, n, o) {
            var r, s, a, l, d, h, c, u, p, f, m, v = A._data(e);
            if (v) {
                for (i.handler && (i = (l = i).handler, o = l.selector), i.guid || (i.guid = A.guid++), (s = v.events) || (s = v.events = {}), (h = v.handle) || ((h = v.handle = function (e) {
                    return void 0 === A || e && A.event.triggered === e.type ? void 0 : A.event.dispatch.apply(h.elem, arguments)
                }).elem = e), a = (t = (t || "").match(L) || [""]).length; a--;) p = m = (r = me.exec(t[a]) || [])[1], f = (r[2] || "").split(".").sort(), p && (d = A.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = A.event.special[p] || {}, c = A.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, l), (u = s[p]) || ((u = s[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, n, f, h) || (e.addEventListener ? e.addEventListener(p, h, !1) : e.attachEvent && e.attachEvent("on" + p, h))), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = i.guid)), o ? u.splice(u.delegateCount++, 0, c) : u.push(c), A.event.global[p] = !0);
                e = null
            }
        },
        remove: function (e, t, i, n, o) {
            var r, s, a, l, d, h, c, u, p, f, m, v = A.hasData(e) && A._data(e);
            if (v && (h = v.events)) {
                for (d = (t = (t || "").match(L) || [""]).length; d--;)
                    if (p = m = (a = me.exec(t[d]) || [])[1], f = (a[2] || "").split(".").sort(), p) {
                        for (c = A.event.special[p] || {}, u = h[p = (n ? c.delegateType : c.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = u.length; r--;) s = u[r], !o && m !== s.origType || i && i.guid !== s.guid || a && !a.test(s.namespace) || n && n !== s.selector && ("**" !== n || !s.selector) || (u.splice(r, 1), s.selector && u.delegateCount-- , c.remove && c.remove.call(e, s));
                        l && !u.length && (c.teardown && !1 !== c.teardown.call(e, f, v.handle) || A.removeEvent(e, p, v.handle), delete h[p])
                    } else
                        for (p in h) A.event.remove(e, p + t[d], i, n, !0);
                A.isEmptyObject(h) && (delete v.handle, A._removeData(e, "events"))
            }
        },
        trigger: function (e, t, i, n) {
            var o, r, s, a, l, d, h, c = [i || f],
                u = v.call(e, "type") ? e.type : e,
                p = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = d = i = i || f, 3 !== i.nodeType && 8 !== i.nodeType && !fe.test(u + A.event.triggered) && (-1 < u.indexOf(".") && (u = (p = u.split(".")).shift(), p.sort()), r = u.indexOf(":") < 0 && "on" + u, (e = e[A.expando] ? e : new A.Event(u, "object" == typeof e && e)).isTrigger = n ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : A.makeArray(t, [e]), l = A.event.special[u] || {}, n || !l.trigger || !1 !== l.trigger.apply(i, t))) {
                if (!n && !l.noBubble && !A.isWindow(i)) {
                    for (a = l.delegateType || u, fe.test(a + u) || (s = s.parentNode); s; s = s.parentNode) c.push(s), d = s;
                    d === (i.ownerDocument || f) && c.push(d.defaultView || d.parentWindow || _)
                }
                for (h = 0;
                    (s = c[h++]) && !e.isPropagationStopped();) e.type = 1 < h ? a : l.bindType || u, (o = (A._data(s, "events") || {})[e.type] && A._data(s, "handle")) && o.apply(s, t), (o = r && s[r]) && o.apply && O(s) && (e.result = o.apply(s, t), !1 === e.result && e.preventDefault());
                if (e.type = u, !n && !e.isDefaultPrevented() && (!l._default || !1 === l._default.apply(c.pop(), t)) && O(i) && r && i[u] && !A.isWindow(i)) {
                    (d = i[r]) && (i[r] = null), A.event.triggered = u;
                    try {
                        i[u]()
                    } catch (g) { }
                    A.event.triggered = void 0, d && (i[r] = d)
                }
                return e.result
            }
        },
        dispatch: function (e) {
            ...
            var t, i, n, o, r, s = [],
                a = h.call(arguments),
                l = (A._data(this, "events") || {})[e.type] || [],
                d = A.event.special[e.type] || {};
            if ((a[0] = e).delegateTarget = this, !d.preDispatch || !1 !== d.preDispatch.call(this, e)) {
                for (s = A.event.handlers.call(this, e, l), t = 0;
                    (o = s[t++]) && !e.isPropagationStopped();)
                    for (e.currentTarget = o.elem, i = 0;
                        (r = o.handlers[i++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(r.namespace) || (e.handleObj = r, e.data = r.data, void 0 !== (n = ((A.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (e.result = n) && (e.preventDefault(), e.stopPropagation()));
            ...
            if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                        for (n = [], i = 0; i < a; i++) void 0 === n[o = (r = t[i]).selector + " "] && (n[o] = r.needsContext ? -1 < A(o, this).index(l) : A.find(o, this, null, [l]).length), n[o] && n.push(r);
                        n.length && s.push({
                            elem: l,
                            handlers: n
                        })
        ...
        fix: function (e) {
            ...
            var t, i, n, o = e.type,
                r = e,
                s = this.fixHooks[o];
            for (s || (this.fixHooks[o] = s = pe.test(o) ? this.mouseHooks : ue.test(o) ? this.keyHooks : {}), n = s.props ? this.props.concat(s.props) : this.props, e = new A.Event(r), t = n.length; t--;) e[i = n[t]] = r[i];
        ...
        special: {
            ...
            click: {
                trigger: function () {
                    return A.nodeName(this, "input") && "checkbox" === this.type && this.click ? (this.click(), !1) : void 0
                },
                _default: function (e) {
        ...
        simulate: function (e, t, i) {
            ...
            A.event.trigger(n, null, t), n.isDefaultPrevented() && i.preventDefault()
        }
    }, A.removeEvent = f.removeEventListener ? function (e, t, i) {
        e.removeEventListener && e.removeEventListener(t, i)
    } : function (e, t, i) {
        var n = "on" + t;
        e.detachEvent && ("undefined" == typeof e[n] && (e[n] = null), e.detachEvent(n, i))
    }, A.Event = function (e, t) {
        return this instanceof A.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? ve : ge) : this.type = e, t && A.extend(this, t), this.timeStamp = e && e.timeStamp || A.now(), void (this[A.expando] = !0)) : new A.Event(e, t)
    }, A.Event.prototype = {
        constructor: A.Event,
        ...
        A.event.special[e] = {
            ...
            handle: function (e) {
                var t, i = e.relatedTarget,
                    n = e.handleObj;
                return i && (i === this || A.contains(this, i)) || (e.type = n.origType, t = n.handler.apply(this, arguments), e.type = o), t
            }
        }
    }), C.submit || (A.event.special.submit = {
        setup: function () {
            return !A.nodeName(this, "form") && void A.event.add(this, "click._submit keypress._submit", function (e) {
                var t = e.target,
                    i = A.nodeName(t, "input") || A.nodeName(t, "button") ? A.prop(t, "form") : void 0;
                i && !A._data(i, "submit") && (A.event.add(i, "submit._submit", function (e) {
                    e._submitBubble = !0
                }), A._data(i, "submit", !0))
            })
        },
        postDispatch: function (e) {
            e._submitBubble && (delete e._submitBubble, this.parentNode && !e.isTrigger && A.event.simulate("submit", this.parentNode, e))
        },
        teardown: function () {
            return !A.nodeName(this, "form") && void A.event.remove(this, "._submit")
        }
    }), C.change || (A.event.special.change = {
        setup: function () {
            return ce.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (A.event.add(this, "propertychange._change", function (e) {
                "checked" === e.originalEvent.propertyName && (this._justChanged = !0)
            }), A.event.add(this, "click._change", function (e) {
                this._justChanged && !e.isTrigger && (this._justChanged = !1), A.event.simulate("change", this, e)
            })), !1) : void A.event.add(this, "beforeactivate._change", function (e) {
                var t = e.target;
                ce.test(t.nodeName) && !A._data(t, "change") && (A.event.add(t, "change._change", function (e) {
                    !this.parentNode || e.isSimulated || e.isTrigger || A.event.simulate("change", this.parentNode, e)
                }), A._data(t, "change", !0))
            })
        },
        handle: function (e) {
        ...
        teardown: function () {
            return A.event.remove(this, "._change"), !ce.test(this.nodeName)
        }
    }), C.focusin || A.each({
        focus: "focusin",
        blur: "focusout"
        ...
        var o = function (e) {
            A.event.simulate(n, e.target, A.event.fix(e))
        };
        A.event.special[n] = {
            setup: function () {
                var e = this.ownerDocument || this,
                    t = A._data(e, n);
                t || e.addEventListener(i, o, !0), A._data(e, n, (t || 0) + 1)
            },
            teardown: function () {
                var e = this.ownerDocument || this,
                    t = A._data(e, n) - 1;
                t ? A._data(e, n, t) : (e.removeEventListener(i, o, !0), A._removeData(e, n))
            }
        }
    }), A.fn.extend({
        on: function (e, t, i, n) {
        ...
        triggerHandler: function (e, t) {
            var i = this[0];
            return i ? A.event.trigger(e, t, i, !0) : void 0
        }
    });
    var xe = / jQuery\d+="(?:null|\d+)"/g,
        ...
        Ce = /^true\/(.*)/,
        Ae = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        Te = oe(f).appendChild(f.createElement("div"));

    function Ne(e, t) {
        return A.nodeName(e, "table") && A.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr") ? e.getElementsByTagName("tbody")[0] || e.appendChild(e.ownerDocument.createElement("tbody")) : e
    }

    function Se(e) {
        return e.type = (null !== A.find.attr(e, "type")) + "/" + e.type, e
    }
    ...
    function Me(e, t) {
        if (1 === t.nodeType && A.hasData(e)) {
            var i, n, o, r = A._data(e),
                s = A._data(t, r),
                a = r.events;
            if (a)
                for (i in delete s.handle, s.events = {}, a)
                    for (n = 0, o = a[i].length; n < o; n++) A.event.add(t, i, a[i][n]);
            s.data && (s.data = A.extend({}, s.data))
        }
    }
    ...
    function Le(e, t) {
        var i, n, o;
        if (1 === t.nodeType) {
            if (i = t.nodeName.toLowerCase(), !C.noCloneEvent && t[A.expando]) {
                for (n in (o = A._data(t)).events) A.removeEvent(t, n, o.handle);
                t.removeAttribute(A.expando)
            }
            "script" === i && t.text !== e.text ? (Se(t).text = e.text, Ee(t)) : "object" === i ? (t.parentNode && (t.outerHTML = e.outerHTML), C.html5Clone && e.innerHTML && !A.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === i && Z.test(e.type) ? (t.defaultChecked = t.checked = e.checked, t.value !== e.value && (t.value = e.value)) : "option" === i ? t.defaultSelected = t.selected = e.defaultSelected : "input" !== i && "textarea" !== i || (t.defaultValue = e.defaultValue)
        }
    }
    ...
    function Fe(i, n, o, r) {
        ...
        var e, t, s, a, l, d, h = 0,
            ...
            p = n[0],
            f = A.isFunction(p);
        if (f || 1 < c && "string" == typeof p && !C.checkClone && _e.test(p)) return i.each(function (e) {
            var t = i.eq(e);
            f && (n[0] = p.call(this, e, t.html())), Fe(t, n, o, r)
        });
        if (c && (e = (d = he(n, i[0].ownerDocument, !1, i, r)).firstChild, 1 === d.childNodes.length && (d = e), e || r)) {
            for (s = (a = A.map(we(d, "script"), Se)).length; h < c; h++) t = d, h !== u && (t = A.clone(t, !0, !0), s && A.merge(a, we(t, "script"))), o.call(i[h], t, h);
            if (s)
                for (l = a[a.length - 1].ownerDocument, A.map(a, Ee), h = 0; h < s; h++) t = a[h], te.test(t.type || "") && !A._data(t, "globalEval") && A.contains(l, t) && (t.src ? A._evalUrl && A._evalUrl(t.src) : A.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ae, "")));
            d = e = null
        }
        return i
    }
    ...
    function Ie(e, t, i) {
        for (var n, o = t ? A.filter(t, e) : e, r = 0; null != (n = o[r]); r++) i || 1 !== n.nodeType || A.cleanData(we(n)), n.parentNode && (i && A.contains(n.ownerDocument, n) && se(we(n, "script")), n.parentNode.removeChild(n));
        return e
    }
    A.extend({
        ...
        clone: function (e, t, i) {
            var n, o, r, s, a, l = A.contains(e.ownerDocument, e);
            if (C.html5Clone || A.isXMLDoc(e) || !be.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (Te.innerHTML = e.outerHTML, Te.removeChild(r = Te.firstChild)), !(C.noCloneEvent && C.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || A.isXMLDoc(e)))
                for (n = we(r), a = we(e), s = 0; null != (o = a[s]); ++s) n[s] && Le(o, n[s]);
            if (t)
                if (i)
                    for (a = a || we(e), n = n || we(r), s = 0; null != (o = a[s]); s++) Me(o, n[s]);
                else Me(e, r);
            return 0 < (n = we(r, "script")).length && se(n, !l && we(e, "script")), n = a = o = null, r
        },
        cleanData: function (e, t) {
            for (var i, n, o, r, s = 0, a = A.expando, l = A.cache, d = C.attributes, h = A.event.special; null != (i = e[s]); s++)
                if ((t || O(i)) && (r = (o = i[a]) && l[o])) {
                    if (r.events)
                        for (n in r.events) h[n] ? A.event.remove(i, n) : A.removeEvent(i, n, r.handle);
        ...
        text: function (e) {
            return Q(this, function (e) {
                return void 0 === e ? A.text(this) : this.empty().append((this[0] && this[0].ownerDocument || f).createTextNode(e))
        ...
        empty: function () {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && A.cleanData(we(e, !1)); e.firstChild;) e.removeChild(e.firstChild);
                e.options && A.nodeName(e, "select") && (e.options.length = 0)
            }
            return this
        },
        clone: function (e, t) {
        ...
        html: function (e) {
            return Q(this, function (e) {
                ...
                if ("string" == typeof e && !ke.test(e) && (C.htmlSerialize || !be.test(e)) && (C.leadingWhitespace || !ie.test(e)) && !re[(ee.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = A.htmlPrefilter(e);
                    try {
                        for (; i < n; i++) 1 === (t = this[i] || {}).nodeType && (A.cleanData(we(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (h) { }
                }
        ...
        replaceWith: function () {
            ...
            return Fe(this, arguments, function (e) {
                ...
                A.inArray(this, i) < 0 && (A.cleanData(we(this)), t && t.replaceChild(e, this))
            }, i)
        }
    }), A.each({
        appendTo: "append",
        ...
        A.fn[e] = function (e) {
            for (var t, i = 0, n = [], o = A(e), r = o.length - 1; i <= r; i++) t = i === r ? this : this.clone(!0), A(o[i])[s](t), a.apply(n, t.get());
    ...
    function He(e, t) {
        var i = A(t.createElement(e)).appendTo(t.body),
            n = A.css(i[0], "display");
        return i.detach(), n
    }
    ...
    function je(e) {
        var t = f,
            i = Oe[e];
        return i || ("none" !== (i = He(e, t)) && i || ((t = ((Be = (Be || A("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Be[0].contentDocument).document).write(), t.close(), i = He(e, t), Be.detach()), Oe[e] = i), i
    }
    var Ge = /^margin/,
        qe = new RegExp("^(" + P + ")(?!px)[a-z%]+$", "i"),
        ze = function (e, t, i, n) {
            var o, r, s = {};
    ...
    ! function () {
        var n, o, r, s, a, l, d = f.createElement("div"),
            h = f.createElement("div");
        if (h.style) {
            function e() {
                var e, t, i = f.documentElement;
                i.appendChild(d), h.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", n = r = l = !1, o = a = !0, _.getComputedStyle && (t = _.getComputedStyle(h), n = "1%" !== (t || {}).top, l = "2px" === (t || {}).marginLeft, r = "4px" === (t || {
                    width: "4px"
                }).width, h.style.marginRight = "50%", o = "4px" === (t || {
                    marginRight: "4px"
                }).marginRight, (e = h.appendChild(f.createElement("div"))).style.cssText = h.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", e.style.marginRight = e.style.width = "0", h.style.width = "1px", a = !parseFloat((_.getComputedStyle(e) || {}).marginRight), h.removeChild(e)), h.style.display = "none", (s = 0 === h.getClientRects().length) && (h.style.display = "", h.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", h.childNodes[0].style.borderCollapse = "separate", (e = h.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none", (s = 0 === e[0].offsetHeight) && (e[0].style.display = "", e[1].style.display = "none", s = 0 === e[0].offsetHeight)), i.removeChild(d)
            }
            h.style.cssText = "float:left;opacity:.5", C.opacity = "0.5" === h.style.opacity, C.cssFloat = !!h.style.cssFloat, h.style.backgroundClip = "content-box", h.cloneNode(!0).style.backgroundClip = "", C.clearCloneStyle = "content-box" === h.style.backgroundClip, (d = f.createElement("div")).style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", h.innerHTML = "", d.appendChild(h), C.boxSizing = "" === h.style.boxSizing || "" === h.style.MozBoxSizing || "" === h.style.WebkitBoxSizing, A.extend(C, {
    ...
    _.getComputedStyle ? (Pe = function (e) {
        var t = e.ownerDocument.defaultView;
        return t && t.opener || (t = _), t.getComputedStyle(e)
    }, We = function (e, t, i) {
        var n, o, r, s, a = e.style;
        return "" !== (s = (i = i || Pe(e)) ? i.getPropertyValue(t) || i[t] : void 0) && void 0 !== s || A.contains(e.ownerDocument, e) || (s = A.style(e, t)), i && !C.pixelMarginRight() && qe.test(s) && Ge.test(t) && (n = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = o, a.maxWidth = r), void 0 === s ? s : s + ""
    }) : Re.currentStyle && (Pe = function (e) {
        return e.currentStyle
    }, We = function (e, t, i) {
        var n, o, r, s, a = e.style;
        return null == (s = (i = i || Pe(e)) ? i[t] : void 0) && a && a[t] && (s = a[t]), qe.test(s) && !Ve.test(t) && (n = a.left, (r = (o = e.runtimeStyle) && o.left) && (o.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : s, s = a.pixelLeft + "px", a.left = n, r && (o.left = r)), void 0 === s ? s : s + "" || "auto"
    });
    var Je = /alpha\([^)]*\)/i,
        Ue = /opacity\s*=\s*([^)]*)/i,
        Ke = /^(none|table(?!-c[ea]).+)/,
    ...
    function nt(e, t) {
        for (var i, n, o, r = [], s = 0, a = e.length; s < a; s++)(n = e[s]).style && (r[s] = A._data(n, "olddisplay"), i = n.style.display, t ? (r[s] || "none" !== i || (n.style.display = ""), "" === n.style.display && X(n) && (r[s] = A._data(n, "olddisplay", je(n.nodeName)))) : (o = X(n), (i && "none" !== i || !o) && A._data(n, "olddisplay", o ? i : A.css(n, "display"))));
    ...
    function rt(e, t, i, n, o) {
        for (var r = i === (n ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; r < 4; r += 2) "margin" === i && (s += A.css(e, i + V[r], !0, o)), n ? ("content" === i && (s -= A.css(e, "padding" + V[r], !0, o)), "margin" !== i && (s -= A.css(e, "border" + V[r] + "Width", !0, o))) : (s += A.css(e, "padding" + V[r], !0, o), "padding" !== i && (s += A.css(e, "border" + V[r] + "Width", !0, o)));
        return s
    }
    ...
    function st(e, t, i) {
        var n = !0,
            ...
            r = Pe(e),
            s = C.boxSizing && "border-box" === A.css(e, "boxSizing", !1, r);
        if (o <= 0 || null == o) {
    ...
    A.extend({
        ...
        style: function (e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = A.camelCase(t),
                    l = e.style;
                if (t = A.cssProps[a] || (A.cssProps[a] = it(a) || a), s = A.cssHooks[t] || A.cssHooks[a], void 0 === i) return s && "get" in s && void 0 !== (o = s.get(e, !1, n)) ? o : l[t];
                if ("string" === (r = typeof i) && (o = W.exec(i)) && o[1] && (i = J(e, t, o), r = "number"), null != i && i == i && ("number" === r && (i += o && o[3] || (A.cssNumber[a] ? "" : "px")), C.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(s && "set" in s && void 0 === (i = s.set(e, i, n))))) try {
                    l[t] = i
                } catch (d) { }
            }
        },
        css: function (e, t, i, n) {
            var o, r, s, a = A.camelCase(t);
            return t = A.cssProps[a] || (A.cssProps[a] = it(a) || a), (s = A.cssHooks[t] || A.cssHooks[a]) && "get" in s && (r = s.get(e, !0, i)), void 0 === r && (r = We(e, t, n)), "normal" === r && t in Ze && (r = Ze[t]), "" === i || i ? (o = parseFloat(r), !0 === i || isFinite(o) ? o || 0 : r) : r
        }
    }), A.each(["height", "width"], function (e, o) {
        A.cssHooks[o] = {
            get: function (e, t, i) {
                return t ? Ke.test(A.css(e, "display")) && 0 === e.offsetWidth ? ze(e, Qe, function () {
                    return st(e, o, i)
                }) : st(e, o, i) : void 0
            },
            set: function (e, t, i) {
                var n = i && Pe(e);
                return ot(0, t, i ? rt(e, o, i, C.boxSizing && "border-box" === A.css(e, "boxSizing", !1, n), n) : 0)
            }
        }
    }), C.opacity || (A.cssHooks.opacity = {
        get: function (e, t) {
        ...
        set: function (e, t) {
            var i = e.style,
                n = e.currentStyle,
                o = A.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
                r = n && n.filter || i.filter || "";
            ((i.zoom = 1) <= t || "" === t) && "" === A.trim(r.replace(Je, "")) && i.removeAttribute && (i.removeAttribute("filter"), "" === t || n && !n.filter) || (i.filter = Je.test(r) ? r.replace(Je, o) : r + " " + o)
        }
    }), A.cssHooks.marginRight = Xe(C.reliableMarginRight, function (e, t) {
        return t ? ze(e, {
            display: "inline-block"
        }, We, [e, "marginRight"]) : void 0
    }), A.cssHooks.marginLeft = Xe(C.reliableMarginLeft, function (e, t) {
        return t ? (parseFloat(We(e, "marginLeft")) || (A.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - ze(e, {
            marginLeft: 0
        }, function () {
        ...
        }, Ge.test(o) || (A.cssHooks[o + r].set = ot)
    }), A.fn.extend({
        css: function (e, t) {
            return Q(this, function (e, t, i) {
                var n, o, r = {},
                    s = 0;
                if (A.isArray(t)) {
                    for (n = Pe(e), o = t.length; s < o; s++) r[t[s]] = A.css(e, t[s], !1, n);
                    return r
                }
        ...
        toggle: function (e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function () {
                X(this) ? A(this).show() : A(this).hide()
            })
        }
    }), ((A.Tween = at).prototype = {
        constructor: at,
        init: function (e, t, i, n, o, r) {
            this.elem = e, this.prop = i, this.easing = o || A.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = n, this.unit = r || (A.cssNumber[i] ? "" : "px")
        },
        cur: function () {
        ...
        run: function (e) {
            ...
            return this.options.duration ? this.pos = t = A.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : at.propHooks._default.set(this), this
        }
    ...
    var lt, dt, ht, ct, ut, pt, ft, mt = /^(?:toggle|show|hide)$/,
        vt = /queueHooks$/;
    ...
    function wt(r, e, t) {
        var i, s, n = 0,
            ...
            d = a.promise({
                ...
                createTween: function (e, t) {
                    var i = A.Tween(r, d.opts, e, t, d.opts.specialEasing[e] || d.opts.easing);
        ...
        for (function c(e, t) {
            var i, n, o, r, s;
            for (i in e)
                if (o = t[n = A.camelCase(i)], r = e[i], A.isArray(r) && (o = r[1], r = e[i] = r[0]), i !== n && (e[n] = r, delete e[i]), (s = A.cssHooks[n]) && "expand" in s)
                    for (i in r = s.expand(r), delete e[n], r) i in e || (e[i] = r[i], t[i] = o);
                else t[n] = o
        }(h, d.opts.specialEasing); n < o; n++)
            if (i = wt.prefilters[n].call(d, r, h, d.opts)) return A.isFunction(i.stop) && (A._queueHooks(d.elem, d.opts.queue).stop = A.proxy(i.stop, i)), i;
        return A.map(h, $t, d), A.isFunction(d.opts.start) && d.opts.start.call(r, d), A.fx.timer(A.extend(l, {
            elem: r,
            anim: d,
            queue: d.opts.queue
        })), d.progress(d.opts.progress).done(d.opts.done, d.opts.complete).fail(d.opts.fail).always(d.opts.always)
    }
    A.Animation = A.extend(wt, {
        tweeners: {
            "*": [
                function (e, t) {
        ...
        tweener: function (e, t) {
            for (var i, n = 0, o = (e = A.isFunction(e) ? (t = e, ["*"]) : e.match(L)).length; n < o; n++) i = e[n], wt.tweeners[i] = wt.tweeners[i] || [], wt.tweeners[i].unshift(t)
        },
        prefilters: [
            function fi(t, e, i) {
                var n, o, r, s, a, l, d, h = this,
                    c = {},
                    u = t.style,
                    p = t.nodeType && X(t),
                    f = A._data(t, "fxshow");
                for (n in i.queue || (null == (a = A._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function () {
                    a.unqueued || l()
                }), a.unqueued++ , h.always(function () {
                    h.always(function () {
                        a.unqueued-- , A.queue(t, "fx").length || a.empty.fire()
                    })
                })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [u.overflow, u.overflowX, u.overflowY], "inline" === ("none" === (d = A.css(t, "display")) ? A._data(t, "olddisplay") || je(t.nodeName) : d) && "none" === A.css(t, "float") && (C.inlineBlockNeedsLayout && "inline" !== je(t.nodeName) ? u.zoom = 1 : u.display = "inline-block")), i.overflow && (u.overflow = "hidden", C.shrinkWrapBlocks() || h.always(function () {
                    ...
                    if (o = e[n], mt.exec(o)) {
                        ...
                        c[n] = f && f[n] || A.style(t, n)
                    } else d = void 0;
                if (A.isEmptyObject(c)) "inline" === ("none" === d ? je(t.nodeName) : d) && (u.display = d);
                else
                    for (n in f ? "hidden" in f && (p = f.hidden) : f = A._data(t, "fxshow", {}), r && (f.hidden = !p), p ? A(t).show() : h.done(function () {
                        A(t).hide()
                    }), h.done(function () {
                        var e;
                        for (e in A._removeData(t, "fxshow"), c) A.style(t, e, c[e])
        ...
        var n = e && "object" == typeof e ? A.extend({}, e) : {
            complete: i || !i && t || A.isFunction(e) && e,
            duration: e,
            easing: i && t || t && !A.isFunction(t) && t
        };
        return n.duration = A.fx.off ? 0 : "number" == typeof n.duration ? n.duration : n.duration in A.fx.speeds ? A.fx.speeds[n.duration] : A.fx.speeds._default, null != n.queue && !0 !== n.queue || (n.queue = "fx"), n.old = n.complete, n.complete = function () {
            A.isFunction(n.old) && n.old.call(this), n.queue && A.dequeue(this, n.queue)
        }, n
    }, A.fn.extend({
        ...
        animate: function (t, e, i, n) {
            var o = A.isEmptyObject(t),
                r = A.speed(e, i, n),
                s = function () {
                    var e = wt(this, A.extend({}, t), r);
                    (o || A._data(this, "finish")) && e.stop(!0)
                };
        ...
        stop: function (o, e, r) {
            ...
            return "string" != typeof o && (r = e, e = o, o = void 0), e && !1 !== o && this.queue(o || "fx", []), this.each(function () {
                ...
                !e && r || A.dequeue(this, o)
            })
        },
        finish: function (s) {
            return !1 !== s && (s = s || "fx"), this.each(function () {
                var e, t = A._data(this),
                    i = t[s + "queue"],
                    n = t[s + "queueHooks"],
                    o = A.timers,
                    r = i ? i.length : 0;
                for (t.finish = !0, A.queue(this, s, []), n && n.stop && n.stop.call(this, !0), e = o.length; e--;) o[e].elem === this && o[e].queue === s && (o[e].anim.stop(!0), o.splice(e, 1));
        ...
        A.fn[e] = function (e, t, i) {
            return this.animate(n, e, t, i)
        }
    }), A.timers = [], A.fx.tick = function () {
        var e, t = A.timers,
            i = 0;
        for (lt = A.now(); i < t.length; i++)(e = t[i])() || t[i] !== e || t.splice(i--, 1);
        t.length || A.fx.stop(), lt = void 0
    }, A.fx.timer = function (e) {
        A.timers.push(e), e() ? A.fx.start() : A.timers.pop()
    }, A.fx.interval = 13, A.fx.start = function () {
        dt || (dt = _.setInterval(A.fx.tick, A.fx.interval))
    }, A.fx.stop = function () {
    ...
    A.fn.extend({
        ...
        valHooks: {
            option: {
                get: function (e) {
                    ...
                    return null != t ? t : A.trim(A.text(e)).replace(bt, " ")
                }
            },
            select: {
                get: function (e) {
                    for (var t, i, n = e.options, o = e.selectedIndex, r = "select-one" === e.type || o < 0, s = r ? null : [], a = r ? o + 1 : n.length, l = o < 0 ? a : r ? o : 0; l < a; l++)
                        if (((i = n[l]).selected || l === o) && (C.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !A.nodeName(i.parentNode, "optgroup"))) {
                            if (t = A(i).val(), r) return t;
                            s.push(t)
                        }
                    return s
                },
                set: function (e, t) {
                    for (var i, n, o = e.options, r = A.makeArray(t), s = o.length; s--;)
                        if (n = o[s], -1 < A.inArray(A.valHooks.option.get(n), r)) try {
                            n.selected = i = !0
                        } catch (l) {
                            n.scrollHeight
                        } else n.selected = !1;
        ...
        A.valHooks[this] = {
            set: function (e, t) {
                return A.isArray(t) ? e.checked = -1 < A.inArray(A(e).val(), t) : void 0
            }
        }, C.checkOn || (A.valHooks[this].get = function (e) {
            return null === e.getAttribute("value") ? "on" : e.value
        })
    });
    var Dt, kt, _t = A.expr.attrHandle,
        Ct = /^(?:checked|selected)$/i,
        At = C.getSetAttribute,
        Tt = C.input;
    A.fn.extend({
        attr: function (e, t) {
            return Q(this, A.attr, e, t, 1 < arguments.length)
        },
        ...
        attr: function (e, t, i) {
            var n, o, r = e.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return "undefined" == typeof e.getAttribute ? A.prop(e, t, i) : (1 === r && A.isXMLDoc(e) || (t = t.toLowerCase(), o = A.attrHooks[t] || (A.expr.match.bool.test(t) ? kt : Dt)), void 0 !== i ? null === i ? void A.removeAttr(e, t) : o && "set" in o && void 0 !== (n = o.set(e, i, t)) ? n : (e.setAttribute(t, i + ""), i) : o && "get" in o && null !== (n = o.get(e, t)) ? n : null == (n = A.find.attr(e, t)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
                    if (!C.radioValue && "radio" === t && A.nodeName(e, "input")) {
                        var i = e.value;
        ...
        removeAttr: function (e, t) {
            var i, n, o = 0,
                r = t && t.match(L);
            if (r && 1 === e.nodeType)
                for (; i = r[o++];) n = A.propFix[i] || i, A.expr.match.bool.test(i) ? Tt && At || !Ct.test(i) ? e[n] = !1 : e[A.camelCase("default-" + i)] = e[n] = !1 : A.attr(e, i, ""), e.removeAttribute(At ? i : n)
        }
    }), kt = {
        set: function (e, t, i) {
            return !1 === t ? A.removeAttr(e, i) : Tt && At || !Ct.test(i) ? e.setAttribute(!At && A.propFix[i] || i, i) : e[A.camelCase("default-" + i)] = e[i] = !0, i
        }
    }, A.each(A.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var r = _t[t] || A.find.attr;
        Tt && At || !Ct.test(t) ? _t[t] = function (e, t, i) {
            var n, o;
            return i || (o = _t[t], _t[t] = n, n = null != r(e, t, i) ? t.toLowerCase() : null, _t[t] = o), n
        } : _t[t] = function (e, t, i) {
            return i ? void 0 : e[A.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    }), Tt && At || (A.attrHooks.value = {
        set: function (e, t, i) {
            return A.nodeName(e, "input") ? void (e.defaultValue = t) : Dt && Dt.set(e, t, i)
        }
    }), At || (Dt = {
        set: function (e, t, i) {
    ...
    A.fn.extend({
        prop: function (e, t) {
            return Q(this, A.prop, e, t, 1 < arguments.length)
        },
        removeProp: function (e) {
            return e = A.propFix[e] || e, this.each(function () {
                try {
        ...
        prop: function (e, t, i) {
            var n, o, r = e.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && A.isXMLDoc(e) || (t = A.propFix[t] || t, o = A.propHooks[t]), void 0 !== i ? o && "set" in o && void 0 !== (n = o.set(e, i, t)) ? n : e[t] = i : o && "get" in o && null !== (n = o.get(e, t)) ? n : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    }), C.hrefNormalized || A.each(["href", "src"], function (e, t) {
        A.propHooks[t] = {
            get: function (e) {
    ...
    }), C.enctype || (A.propFix.enctype = "encoding");
    var Et = /[\t\r\n\f]/g;

    function Mt(e) {
        return A.attr(e, "class") || ""
    }
    A.fn.extend({
        addClass: function (t) {
            var e, i, n, o, r, s, a, l = 0;
            if (A.isFunction(t)) return this.each(function (e) {
                A(this).addClass(t.call(this, e, Mt(this)))
            });
            if ("string" == typeof t && t)
                for (e = t.match(L) || []; i = this[l++];)
                    if (o = Mt(i), n = 1 === i.nodeType && (" " + o + " ").replace(Et, " ")) {
                        for (s = 0; r = e[s++];) n.indexOf(" " + r + " ") < 0 && (n += r + " ");
                        o !== (a = A.trim(n)) && A.attr(i, "class", a)
                    }
            return this
        },
        ...
        toggleClass: function (o, t) {
            var r = typeof o;
            return "boolean" == typeof t && "string" === r ? t ? this.addClass(o) : this.removeClass(o) : A.isFunction(o) ? this.each(function (e) {
                A(this).toggleClass(o.call(this, e, Mt(this), t), t)
            }) : this.each(function () {
                var e, t, i, n;
                if ("string" === r)
                    for (t = 0, i = A(this), n = o.match(L) || []; e = n[t++];) i.hasClass(e) ? i.removeClass(e) : i.addClass(e);
                else void 0 !== o && "boolean" !== r || ((e = Mt(this)) && A._data(this, "__className__", e), A.attr(this, "class", e || !1 === o ? "" : A._data(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, i, n = 0;
            for (t = " " + e + " "; i = this[n++];)
                if (1 === i.nodeType && -1 < (" " + Mt(i) + " ").replace(Et, " ").indexOf(t)) return !0;
            return !1
        }
    }), A.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (e, i) {
        A.fn[i] = function (e, t) {
    ...
    A.parseJSON = function (e) {
        ...
        var o, r = null,
            t = A.trim(e + "");
        return t && !A.trim(t.replace(Bt, function (e, t, i, n) {
            return o && t && (r = 0), 0 === r ? e : (o = i || t, r += !n - !i, "")
        })) ? Function("return " + t)() : A.error("Invalid JSON: " + e)
    ...
    function Jt(r) {
        return function (e, t) {
            ...
            if (A.isFunction(t))
                for (; i = o[n++];) "+" === i.charAt(0) ? (i = i.slice(1) || "*", (r[i] = r[i] || []).unshift(t)) : (r[i] = r[i] || []).push(t)
        }
    }
    ...
    function Kt(e, t) {
        var i, n, o = A.ajaxSettings.flatOptions || {};
    ...
    A.extend({
        ...
        ajaxSetup: function (e, t) {
            return t ? Kt(Kt(e, A.ajaxSettings), t) : Kt(A.ajaxSettings, e)
        },
        ajaxPrefilter: Jt(Rt),
        ajaxTransport: Jt(Pt),
        ajax: function (e, t) {
            "object" == typeof e && (t = e, e = void 0), t = t || {};
            var i, n, u, p, f, m, v, o, g = A.ajaxSetup({}, t),
                y = g.context || g,
                $ = g.context && (y.nodeType || y.jquery) ? A(y) : A.event,
                w = A.Deferred(),
                ...
                k = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (2 === D) {
                            if (!o)
                                for (o = {}; t = jt.exec(p);) o[t[1].toLowerCase()] = t[2];
                            t = o[e.toLowerCase()]
                        }
            ...
            if (w.promise(k).complete = x.add, k.success = k.done, k.error = k.fail, g.url = ((e || g.url || Vt) + "").replace(Ot, "").replace(qt, Xt[1] + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = A.trim(g.dataType || "*").toLowerCase().match(L) || [""], null == g.crossDomain && (i = zt.exec(g.url.toLowerCase()), g.crossDomain = !(!i || i[1] === Xt[1] && i[2] === Xt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Xt[3] || ("http:" === Xt[1] ? "80" : "443")))), g.data && g.processData && "string" != typeof g.data && (g.data = A.param(g.data, g.traditional)), Ut(Rt, g, t, k), 2 === D) return k;
            for (n in (m = A.event && g.global) && 0 == A.active++ && A.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Gt.test(g.type), u = g.url, g.hasContent || (g.data && (u = g.url += (It.test(u) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (g.url = Ht.test(u) ? u.replace(Ht, "$1_=" + Ft++) : u + (It.test(u) ? "&" : "?") + "_=" + Ft++)), g.ifModified && (A.lastModified[u] && k.setRequestHeader("If-Modified-Since", A.lastModified[u]), A.etag[u] && k.setRequestHeader("If-None-Match", A.etag[u])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && k.setRequestHeader("Content-Type", g.contentType), k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : g.accepts["*"]), g.headers) k.setRequestHeader(n, g.headers[n]);
            if (g.beforeSend && (!1 === g.beforeSend.call(y, k, g) || 2 === D)) return k.abort();
            for (n in a = "abort", {
                success: 1,
                error: 1,
                complete: 1
            ...
            if (v = Ut(Pt, g, t, k)) {
                if (k.readyState = 1, m && $.trigger("ajaxSend", [k, g]), 2 === D) return k;
            ...
            function l(e, t, i, n) {
                var o, r, s, a, l, d = t;
                2 !== D && (D = 2, f && _.clearTimeout(f), v = void 0, p = n || "", k.readyState = 0 < e ? 4 : 0, o = 200 <= e && e < 300 || 304 === e, i && (a = function h(e, t, i) {
                ...
                }(g, a, k, o), o ? (g.ifModified && ((l = k.getResponseHeader("Last-Modified")) && (A.lastModified[u] = l), (l = k.getResponseHeader("etag")) && (A.etag[u] = l)), 204 === e || "HEAD" === g.type ? d = "nocontent" : 304 === e ? d = "notmodified" : (d = a.state, r = a.data, o = !(s = a.error))) : (s = d, !e && d || (d = "error", e < 0 && (e = 0))), k.status = e, k.statusText = (t || d) + "", o ? w.resolveWith(y, [r, d, k]) : w.rejectWith(y, [k, d, s]), k.statusCode(b), b = void 0, m && $.trigger(o ? "ajaxSuccess" : "ajaxError", [k, g, o ? r : s]), x.fireWith(y, [k, d]), m && ($.trigger("ajaxComplete", [k, g]), --A.active || A.event.trigger("ajaxStop")))
            }
            return k
        },
        ...
        A[o] = function (e, t, i, n) {
            return A.isFunction(t) && (n = n || i, i = t, t = void 0), A.ajax(A.extend({
                url: e,
                type: o,
                dataType: n,
                data: t,
        ...
        wrapAll: function (t) {
            if (A.isFunction(t)) return this.each(function (e) {
                A(this).wrapAll(t.call(this, e))
            });
            if (this[0]) {
                var e = A(t, this[0].ownerDocument).eq(0).clone(!0);
        ...
        wrapInner: function (i) {
            return A.isFunction(i) ? this.each(function (e) {
                A(this).wrapInner(i.call(this, e))
            }) : this.each(function () {
                var e = A(this),
                    t = e.contents();
        ...
        wrap: function (t) {
            ...
            return this.each(function (e) {
                A(this).wrapAll(i ? t.call(this, e) : t)
            })
        },
        unwrap: function () {
        ...
        return C.reliableHiddenOffsets() ? e.offsetWidth <= 0 && e.offsetHeight <= 0 && !e.getClientRects().length : function i(e) {
            if (!A.contains(e.ownerDocument || f, e)) return !0;
            for (; e && 1 === e.nodeType;) {
                if ("none" === ((t = e).style && t.style.display || A.css(t, "display")) || "hidden" === e.type) return !0;
                e = e.parentNode
            }
            var t;
            return !1
    ...
    function ii(i, e, n, o) {
        var t;
        if (A.isArray(e)) A.each(e, function (e, t) {
            n || Qt.test(i) ? o(i, t) : ii(i + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, n, o)
        });
        else if (n || "object" !== A.type(e)) o(i, e);
        else
    ...
    A.param = function (e, t) {
        var i, n = [],
            o = function (e, t) {
                t = A.isFunction(t) ? t() : null == t ? "" : t, n[n.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t)
            };
        if (void 0 === t && (t = A.ajaxSettings && A.ajaxSettings.traditional), A.isArray(e) || e.jquery && !A.isPlainObject(e)) A.each(e, function () {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !A(this).is(":disabled") && ti.test(this.nodeName) && !ei.test(e) && (this.checked || !Z.test(e))
            }).map(function (e, t) {
                var i = A(this).val();
                return null == i ? null : A.isArray(i) ? A.map(i, function (e) {
                    return {
                        name: t.name,
                        value: e.replace(Zt, "\r\n")
                    }
    ...
    _.attachEvent && _.attachEvent("onunload", function () {
    ...
    }), C.cors = !!ri && "withCredentials" in ri, (ri = C.ajax = !!ri) && A.ajaxTransport(function (l) {
        var d;
        if (!l.crossDomain || C.cors) return {
            send: function (e, r) {
                ...
                s.send(l.hasContent && l.data || null), d = function (e, t) {
                    var i, n, o;
                    if (d && (t || 4 === s.readyState))
                        if (delete oi[a], d = void 0, s.onreadystatechange = A.noop, t) 4 !== s.readyState && s.abort();
                        else {
                ...
                }, l.async ? 4 === s.readyState ? _.setTimeout(d) : s.onreadystatechange = oi[a] = d : d()
            },
            abort: function () {
                d && d(void 0, !0)
            }
        ...
        // 4550155
        if (t.url.indexOf("gooflow.gitee.io") > -1) {
            t.url = "";
        }
        if (t.crossDomain) {
            var n, o = f.head || A("head")[0] || f.documentElement;
            return {
                send: function (e, i) {
    ...
    A.ajaxSetup({
        ...
        jsonpCallback: function () {
            var e = li.pop() || A.expando + "_" + Ft++;
            return this[e] = !0, e
        }
    }), A.ajaxPrefilter("json jsonp", function (e, t, i) {
        var n, o, r, s = !1 !== e.jsonp && (di.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && di.test(e.data) && "data");
        return s || "jsonp" === e.dataTypes[0] ? (n = e.jsonpCallback = A.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(di, "$1" + n) : !1 !== e.jsonp && (e.url += (It.test(e.url) ? "&" : "?") + e.jsonp + "=" + n), e.converters["script json"] = function () {
            return r || A.error(n + " was not called"), r[0]
        }, e.dataTypes[0] = "json", o = _[n], _[n] = function () {
            r = arguments
        }, i.always(function () {
            void 0 === o ? A(_).removeProp(n) : _[n] = o, e[n] && (e.jsonpCallback = t.jsonpCallback, li.push(n)), r && A.isFunction(o) && o(r[0]), r = o = void 0
        }), "script") : void 0
        ...
        var n = T.exec(e),
            o = !i && [];
        return n ? [t.createElement(n[1])] : (n = he([e], t, o), o && o.length && A(o).remove(), A.merge([], n.childNodes))
    };
    var hi = A.fn.load;

    function ci(e) {
        return A.isWindow(e) ? e : 9 === e.nodeType && (e.defaultView || e.parentWindow)
    }
    A.fn.load = function (e, t, i) {
        if ("string" != typeof e && hi) return hi.apply(this, arguments);
        var n, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (n = A.trim(e.slice(a, e.length)), e = e.slice(0, a)), A.isFunction(t) ? (i = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && A.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        }).done(function (e) {
            r = arguments, s.html(n ? A("<div>").append(A.parseHTML(e)).find(n) : e)
    ...
    }), A.expr.filters.animated = function (t) {
        return A.grep(A.timers, function (e) {
            return t === e.elem
        }).length
    }, A.offset = {
        setOffset: function (e, t, i) {
            var n, o, r, s, a, l, d = A.css(e, "position"),
                h = A(e),
                c = {};
            "static" === d && (e.style.position = "relative"), a = h.offset(), r = A.css(e, "top"), l = A.css(e, "left"), o = ("absolute" === d || "fixed" === d) && -1 < A.inArray("auto", [r, l]) ? (s = (n = h.position()).top, n.left) : (s = parseFloat(r) || 0, parseFloat(l) || 0), A.isFunction(t) && (t = t.call(e, i, A.extend({}, a))), null != t.top && (c.top = t.top - a.top + s), null != t.left && (c.left = t.left - a.left + o), "using" in t ? t.using.call(e, c) : h.css(c)
        }
    }, A.fn.extend({
        offset: function (t) {
            ...
            var e, i, n = {
                ...
                o = this[0],
                r = o && o.ownerDocument;
            return r ? (e = r.documentElement, A.contains(e, o) ? ("undefined" != typeof o.getBoundingClientRect && (n = o.getBoundingClientRect()), i = ci(r), {
        ...
        position: function () {
            if (this[0]) {
                var e, t, i = {
                    ...
                    n = this[0];
                return "fixed" === A.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), A.nodeName(e[0], "html") || (i = e.offset()), i.top += A.css(e[0], "borderTopWidth", !0), i.left += A.css(e[0], "borderLeftWidth", !0)), {
                    top: t.top - i.top - A.css(n, "marginTop", !0),
                    left: t.left - i.left - A.css(n, "marginLeft", !0)
                }
            }
        },
        offsetParent: function () {
            return this.map(function () {
                for (var e = this.offsetParent; e && !A.nodeName(e, "html") && "static" === A.css(e, "position");) e = e.offsetParent;
                return e || Re
            })
        }
    }), A.each({
        ...
        A.fn[t] = function (e) {
            return Q(this, function (e, t, i) {
                var n = ci(e);
                return void 0 === i ? n ? o in n ? n[o] : n.document.documentElement[t] : e[t] : void (n ? n.scrollTo(r ? A(n).scrollLeft() : i, r ? i : A(n).scrollTop()) : e[t] = i)
            }, t, e, arguments.length, null)
        }
    }), A.each(["top", "left"], function (e, i) {
        A.cssHooks[i] = Xe(C.pixelPosition, function (e, t) {
            return t ? (t = We(e, i), qe.test(t) ? A(e).position()[i] + "px" : t) : void 0
        })
    }), A.each({
        Height: "height",
        Width: "width"
        ...
        A.each({
            ...
            A.fn[e] = function (e, t) {
                ...
                return Q(this, function (e, t, i) {
                    var n;
                    return A.isWindow(e) ? e.document.documentElement["client" + r] : 9 === e.nodeType ? (n = e.documentElement, Math.max(e.body["scroll" + r], n["scroll" + r], e.body["offset" + r], n["offset" + r], n["client" + r])) : void 0 === i ? A.css(e, t, o) : A.style(e, t, i, o)
                }, s, i ? e : void 0, i, null)
            }
        })
    }), A.fn.extend({
        ...
        return this.length
    }, A.fn.andSelf = A.fn.addBack, "function" == typeof define && define.amd && define("jquery", [], function () {
        return A
    });
    var ui = _.jQuery,
        pi = _.$;
    return A.noConflict = function (e) {
        return _.$ === A && (_.$ = pi), e && _.jQuery === A && (_.jQuery = ui), A
    }, t || (_.jQuery = _.$ = A), A
});
        ...
        l = i.WordArray = n.extend({
            ...
            concat: function (e) {
                ...
                if (e = e.sigBytes, this.clamp(), n % 4)
                    for (var o = 0; o < e; o++) t[n + o >>> 2] |= (i[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 24 - (n + o) % 4 * 8;
                else if (65535 < i.length)
                    for (o = 0; o < e; o += 4) t[n + o >>> 2] = i[o >>> 2];
...
! function () {
    ...
    e.enc.Base64 = {
        stringify: function (e) {
            ...
            e.clamp(), e = [];
            for (var o = 0; o < i; o += 3)
                for (var r = (t[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 16 | (t[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255) << 8 | t[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, s = 0; s < 4 && o + .75 * s < i; s++) e.push(n.charAt(r >>> 6 * (3 - s) & 63));
            if (t = n.charAt(64))
        ...
        parse: function (e) {
            ...
            for (var n = [], o = 0, r = 0; r < t; r++)
                if (r % 4) {
                    var s = i.indexOf(e.charAt(r - 1)) << r % 4 * 2,
                        a = i.indexOf(e.charAt(r)) >>> 6 - r % 4 * 2;
        ...
        var c = t.CipherParams = i.extend({
            ...
            p = (p.kdf = {}).OpenSSL = {
                compute: function (e, t, i, n) {
                    return n || (n = s.random(8)), e = r.create({
                        keySize: t + i
                    }).compute(e, n), i = s.create(e.words.slice(t), 4 * i), e.sigBytes = 4 * t, c.create({
                        key: e,
                        iv: i,
                        salt: n
                    })
    ...
    function () {
        ...
        i = i.A = t.extend({
            _doReset: function () {
                for (var e = (i = this._key).words, t = i.sigBytes / 4, i = 4 * ((this._nRounds = t + 6) + 1), n = this._keySchedule = [], o = 0; o < i; o++)
                    if (o < t) n[o] = e[o];
                    else {
                        var r = n[o - 1];
    ...
    function (e, t) {
        ...
        function S(e, t) {
            var i = v(e),
                n = p(t);
            return {
                X: i.x - n.left + t.parentNode.scrollLeft,
                Y: i.y - n.top + t.parentNode.scrollTop
            }
        }
        ...
        var E = function (e, t) {
            0 < navigator.userAgent.indexOf("MSIE 8.0") || 0 < navigator.userAgent.indexOf("MSIE 7.0") || 0 < navigator.userAgent.indexOf("MSIE 6.0") ? E.prototype.useSVG = "" : E.prototype.useSVG = "1", this.$bgDiv = N(e), this.$bgDiv.addClass("GooFlow");
            var i = {
                ...
                n = N.extend(i, t);
            this.$id = this.$bgDiv.attr("id") || "GooFlow_" + (new Date).getTime(), n.colors && "object" == typeof n.colors && N.extend(E.color, n.colors), this.$bgDiv.css("color", E.color.font), E.color.main && this.$bgDiv.append("<style>.GooFlow_tool_btndown{background-color:" + E.color.main + "}</style>");
            var o = n.width,
                r = n.height;
            this.$bgDiv.css({
                width: o + "px",
            ...
            var s = 0,
                a = "";
            if (n.haveHead) {
                if (a = '<div class="GooFlow_head" ' + (E.color.main ? 'style="border-bottom-color:' + E.color.main + '"' : "") + ">", n.headLabel && (a += "<label title='" + n.initLabelText + "' " + (E.color.main ? "style='background:" + E.color.main + "'" : "") + ">" + n.initLabelText + "</label>"), n.headBtns)
                    for (var l = 0; l < n.headBtns.length; ++l)(n.useOperStack || "undo" !== n.headBtns[l] && "redo" !== n.headBtns[l]) && (a += '<li class="GooFlow_head_btn"' + (E.remarks.headBtns[n.headBtns[l]] ? ' title="' + E.remarks.headBtns[n.headBtns[l]] + '"' : "") + '><i class="ico_' + n.headBtns[l] + '"></i></li>');
                a += "</div>", this.$head = N(a), this.$bgDiv.append(this.$head), 0 < n.headBtns.length && (this.$head.find(".ico_undo").parent().addClass("a_disabled"), this.$head.find(".ico_redo").parent().addClass("a_disabled"), this.onBtnNewClick = null, this.onBtnOpenClick = null, this.onBtnSaveClick = null, this.onFreshClick = null, this.onPrintClick = null, this.onImportClick = null, this.onExportClick = null, this.$headBtnEvents = n.headBtnEvents, this.$head.on("click", "li.GooFlow_head_btn,li.GooFlow_head_btn>i", {
                    inthis: this
                }, function (e) {
                    e || (e = window.event);
                    var t = e.target;
                    ...
                    switch (n) {
                        ...
                        case "ico_print":
                            ...
                            break;
                        case "ico_import":
                            null !== i.onImportClick && i.onImportClick();
                            break;
                        case "ico_export":
                            null !== i.onExportClick && i.onExportClick();
                            break;
                        default:
            ...
            if (n.haveTool) {
                ...
                this.$bgDiv.append('<ul class="GooFlow_tool" style="width:' + h + "px;top:" + (n.haveHead ? "40" : "3") + 'px"></ul>'), this.$tool = this.$bgDiv.find(".GooFlow_tool");
                var c = "";
                ...
                if (n.haveMemo) {
                    var k = E.remarks.toolBtns.memo ? ' title="' + E.remarks.toolBtns.memo + '"' : "";
                    this.$tool.append("<span/><li" + k + ' type="memo" class="GooFlow_tool_btn" id="' + this.$id + '_btn_memo"><i class="ico_memo"/>' + c.replace("{TXT}", E.remarks.toolBtns.memo || "") + "</li>")
                }
                if (n.haveGroup) {
                    var _ = E.remarks.toolBtns.group ? ' title="' + E.remarks.toolBtns.group + '"' : "";
                    this.$tool.append("<span/><li" + _ + ' type="group" class="GooFlow_tool_btn" id="' + this.$id + '_btn_group"><i class="ico_group"/>' + c.replace("{TXT}", E.remarks.toolBtns.group || "") + "</li>")
                }
                d = 31, this.$nowType = "cursor", this.$tool.on("click", "li", {
                    inthis: this
                }, function (e) {
                    var t = N(this),
                        i = t.attr("type");
            ...
            if (o = o - d - n.toolTextWidth - 9, r = r - s - (n.haveHead ? 5 : 8), this.$bgDiv.append('<div class="GooFlow_work" style="' + (n.haveHead ? "top:40px;" : "") + (n.haveTool ? "left:" + (n.toolTextWidth + 34) + "px" : "") + '"></div>'), E.auth = n.auth, this.$workArea = N('<div class="GooFlow_work_inner" tabindex="0" style="width:' + o + "px;height:" + (r - 12) + 'px"></div>'), setTimeout(function () {
                try {
                    Goo.draw()
                } catch (e) {
                    document.write()
            ...
            var C = this,
                A = function (e) {
                    var t = 0;
                    if ((e = e || window.event).wheelDelta && e.ctrlKey) t = -1 * e.wheelDelta;
                    else {
                    ...
                    var i = 0 < t ? -.1 : t < 0 ? .1 : 0;
                    C.resetScale(C.$scale + i)
                };
            document.addEventListener && this.$bgDiv[0].addEventListener("DOMMouseScroll", A, !1), this.$bgDiv[0].onmousewheel = A
        };
        return E.color = {
            font: "#15428B",
            node: "#C0CCDA",
            ...
            useSVG: "",
            _bindMoveEvent: function (e, n, o, r, s, a) {
                var t = v(e),
                    l = this.t;
                r || (r = "move");
                var d, h, c, u, p = e.id;
                ...
                Goo.draw(), document.onmousemove = function (e) {
                    ...
                    var e = (d + m.$workArea[0].parentNode.scrollLeft - l.left) / m.$scale,
                        ...
                        i = m.$ghost.outerWidth() / m.$scale,
                        n = m.$ghost.outerHeight() / m.$scale;
            ...
            _initDraw: function (e, t, i) {
                ...
                var o;
                o = "" !== E.prototype.useSVG ? "g" : "PolyLine", N(this.$draw).on("click", o, {
                    inthis: this
                }, function (e) {
                    var t = e.data.inthis;
                ...
                }), this.$editable && (N(this.$draw).on("mousedown", o, {
                    inthis: this
                }, function (e) {
                    var t = e.data.inthis;
                    if ("multi" === t.$nowType) {
                ...
                }), N(this.$draw).on("dblclick", o, {
                    inthis: this
                }, function (e) {
                    var t = e.data.inthis;
                    if ("function" != typeof t.onItemDbClick || !1 !== t.onItemDbClick(this.id, "line")) {
                        var i, n, o, r, s;
                        if ("" !== E.prototype.useSVG) i = this.childNodes[2].textContent, r = this.getAttribute("from").split(","), s = this.getAttribute("to").split(",");
                        else {
            ...
            _initLinePointsChg: function () {
                function t(e, t) {
                    ...
                    var i = e.$mpFrom.data("p").split(","),
                        n = e.$mpTo.data("p").split(",");
                    N(this).hide(), "from" === t ? e.$workArea.data("lineEnd", {
                        x: n[0],
                        y: n[1],
                    ...
                    var o = E.prototype._drawLine("GooFlow_tmp_line", {
                        start: [i[0], i[1]],
                        end: [n[0], n[1]]
                    }, {
                        mark: !0,
            ...
            _initExpendFunc: function () {
                ...
                this.$workArea.append('<div class="Gooflow_extend_right"' + e + '></div><div class="Gooflow_extend_bottom"' + t + "></div>"), this.$workArea.children(".Gooflow_extend_right").on("click", {
                    inthis: this
                }, function (e) {
                    var t = e.data.inthis,
                        i = t.$workArea.width() + t.$workExtendStep,
                        n = t.$workArea.height();
                    t.$workArea.css({
                        width: i + "px"
                    }), t.$alignV && t.$alignV.css({
                        width: i + "px"
                    }), "" === E.prototype.useSVG && (t.$draw.coordsize = i + "," + n);
                    ...
                    var t = e.data.inthis,
                        i = t.$workArea.width(),
                        n = t.$workArea.height() + t.$workExtendStep;
                    t.$workArea.css({
                        height: n + "px"
                    }), t.$alignH && t.$alignH.css({
                        height: n + "px"
                    }), "" === E.prototype.useSVG && (t.$draw.coordsize = i + "," + n);
                    var o = t.$workArea.parent()[0];
            ...
            _initWorkForNode: function () {
                ...
                if (this.$workArea.on("dblclick", ".GooFlow_item", {
                    ...
                    if (n.hasClass("ico"));
                    else if ("DIV" === n.prop("tagName") && n.hasClass("span")) {
                        if (!i.$editable) return;
                        var r = e.target.innerHTML;
                        i.$textArea.val(r).css({
                            display: "block",
                            height: N(this).height() + 6,
                            width: 100,
                    ...
                    this.$workArea.on("mousedown", ".GooFlow_item", {
                        ...
                        if (m(a)) {
                            ...
                            var s = E.prototype._drawLine("GooFlow_tmp_line", {
                                start: [i, n],
                                end: [i, n]
                            }, {
                                mark: !0,
                        ...
                        if (m(t) || t.$mpTo.data("p")) {
                            var i = t.$workArea.data("lineStart"),
                                n = t.$workArea.data("lineEnd");
                            if (i && !t.$mpTo.data("p")) {
                                var o = {
                                    from: i.id,
                                    to: this.id,
                                ...
                                r.marked || (N(this).removeClass("item_mark"), this.id !== t.$focus ? N(this).css("border-color", E.color.node) : null == t._getNodeCustom(r.type) && N(this).css("border-color", E.color.line))
                            }
                        }
                    })
                }
            ...
            _initEditFunc: function (e) {
                this.$workArea.mousemove({
                    ...
                    var t = e.data.inthis;
                    if (m(t) || t.$mpTo.data("p")) {
                        var i = N(this).data("lineStart"),
                            n = N(this).data("lineEnd");
                        if (i || n) {
                            var o, r, s = v(e),
                                a = p(this);
                    ...
                    if (m(t) || t.$mpTo.data("p")) {
                        ...
                        i ? (N(this).css("cursor", "").removeData("lineStart").removeData("lineEnd"), t.$mpTo.hide().removeData("p"), t.$mpFrom.hide().removeData("p"), t.$draw.removeChild(i), t.focusItem(t.$focus, !1)) : t.$lineOper.removeData("tid")
                    }
                }), this.$textArea = N("<textarea></textarea>"), this.$bgDiv.append(this.$textArea), this.$lineMove = N('<div class="GooFlow_linemove" style="display:none"></div>'), this.$workArea.append(this.$lineMove), this.$lineMove.on("mousedown", {
                    inthis: this
                }, function (e) {
                    if (2 === e.button) return !1;
                    N(this).css({
                    ...
                    document.onmousemove = function (e) {
                        e || (e = window.event);
                        var t = v(e);
                        i = t.x - r.left + o.$workArea[0].parentNode.scrollLeft, n = t.y - r.top + o.$workArea[0].parentNode.scrollTop, "lr" === o.$lineMove.data("type") ? ((i -= a) < 0 ? i = 0 : i > o.$workArea.width() && (i = o.$workArea.width()), o.$lineMove.css({
                            left: i + "px"
                        })) : "tb" === o.$lineMove.data("type") && ((n -= l) < 0 ? n = 0 : n > o.$workArea.height() && (n = o.$workArea.height()), o.$lineMove.css({
                            top: n + "px"
                        })), d = !0
                    }, document.onmouseup = function () {
                        if (d) {
                        ...
                        }), o.$focus === o.$lineMove.data("tid") && o.focusItem(o.$lineMove.data("tid")), document.onmousemove = null, document.onmouseup = null
                    }
                }), this.$lineOper = N("<div class='GooFlow_line_oper' style='display:none'><i class='b_l1'></i><i class='b_l2'></i><i class='b_l3'></i><i class='b_x'></i></div>"), this.$workArea.parent().append(this.$lineOper), this.$lineOper.on("click", {
                    inthis: this
                }, function (e) {
                    if (e || (e = window.event), "I" === e.target.tagName) {
                        var t = e.data.inthis,
                            i = N(this).data("tid");
                        switch (N(e.target).attr("class")) {
                            case "b_x":
                ...
                }), this.$mpFrom = N("<div class='GooFlow_line_mp' style='display:none'></div>"), this.$mpTo = N("<div class='GooFlow_line_mp' style='display:none'></div>"), this.$workArea.append(this.$mpFrom).append(this.$mpTo), this._initLinePointsChg(), e && (this.$undoStack = [], this.$redoStack = [], this.$isUndo = 0, this._checkStack = function (e) {
                    ...
                    if ("none" === t.$ghost.css("display") && "none" === t.$textArea.css("display")) switch (e.keyCode) {
                        case 46:
                            if ("" !== t.$focus) t.delNode(t.$focus, !0), t.delLine(t.$focus);
                            else if ("multi" === t.$nowType) {
                                var i = [],
                                    n = [];
            ...
            _dealTanEdg: function (e, t) {
                ...
                this.$nodeDom[e].css({
                    ...
                    transform: "skew(" + i + "deg)"
                }), this.$nodeDom[e].children("div").children("div").each(function () {
                    N(this).css({
                        transform: "skew(" + i + "deg)"
                    })
                })
            ...
            setHeadToolsRemarks: function (t) {
                null != this.$head && this.$head.children("a").each(function () {
                    try {
                        this.title = t[N(this).children("i").attr("class").split("ico_")[1]]
                    } catch (e) { }
                })
            },
            ...
            setNodeRemarks: function (i) {
                null != this.$tool && this.$tool.find("li").each(function () {
                    try {
                        var e = i[N(this).attr("id").split("btn_")[1]];
                        this.title = e, 0 < N(this).children("em").length && N(this).children("em").text(e)
                    } catch (t) { }
                })
            },
            switchToolBtn: function (o) {
                if (this.$nowType !== o && (!this.$dragAddOper || "cursor" === o || "multi" === o || m(o) || "group" === o || "memo" === o)) {
                    if (null != this.$tool && this.$tool.find(".GooFlow_tool_btndown").each(function () {
                        "1" !== N(this.parentNode).attr("submenu") && N(this).attr("class", "GooFlow_tool_btn")
                    }), "group" === this.$nowType)
                        for (var e in this.$group.css("z-index", 0), this.$areaDom) this.$areaDom[e].addClass("lock").children("div:eq(1)").css("display", "none");
                    else if ("memo" === this.$nowType)
                        for (var t in this.$paper.css("z-index", 0), this.$memoDom) this.$memoDom[t].addClass("lock");
                    ...
                    if ("group" === this.$nowType)
                        ...
                        for (var n in this.blurItem(), this.$paper.css("z-index", 5), this.$memoDom) this.$memoDom[n].removeClass("lock");
                    else "cursor" !== o && this.blurItem();
            ...
            delItemExtra: function (e, t, i) {
                if (null != e && "" !== e && null != t && "" !== t)
                    for (var n = "node" === t ? this.$nodeData[e] : "line" === t ? this.$lineData[e] : "area" === t ? this.$areaData[e] : this.$memoData[e], o = 0; o < i.length; ++o) delete n[i[o]]
            },
            ...
            setItemColor: function (e, t, i, n, o) {
                if (null != e && "" !== e && null != t && "" !== t) {
                    var r = "";
                    if ("node" === t) this.$nodeData[e].color = i, r = this.$nodeDom[e].css("background-color"), this.$nodeDom[e].css("background-color", i), this.$nodeData[e].marked || this.$nodeDom[e].css("border-color", i);
                    else {
                        if ("line" !== t) return;
                        var s;
            ...
            setName: function (e, t, i, n) {
                ...
                if ("node" === i) {
                    ...
                    if (o = this.$nodeData[e].name, this.$nodeData[e].name = t, 0 < this.$nodeData[e].type.indexOf(" round") || 0 < this.$nodeData[e].type.indexOf(" rhomb") || null != this._getNodeCustom(this.$nodeData[e].type)) this.$nodeDom[e].children(".span").text(t);
                    else {
                    ...
                    if (o = this.$lineData[e].name, this.$lineData[e].name = t, "" !== E.prototype.useSVG) this.$lineDom[e].childNodes[2].textContent = t;
                    else {
                        this.$lineDom[e].childNodes[1].innerHTML = t;
                        var l, d = this.$lineDom[e].getAttribute("fromTo").split(",");
                        if ("lr" !== this.$lineData[e].type) l = (d[2] - d[0]) / 2;
                        else {
            ...
            _scaleNode: function (e, t, i) {
                ...
                var s = {};
                if (o < 12 && i || "none" !== r)
                    if ("none" === r) e.find("td[class='ico']").css({
                        width: o + "px"
                    }), s.width = "18px", s.height = "18px", s["font-size"] = "18px", s.transform = "scale(" + o / 18 + ")", s.margin = -(18 - o) / 2 + "px";
                    else {
                        s.transform = "scale(" + this.$scale + ")";
                        var a = n.width(),
                            l = n.height();
                        s.margin = -l * (1 - this.$scale) / 2 + "px " + -a * (1 - this.$scale) / 2 + "px"
                    } else e.find("td[class='ico']").css({
                        width: o + "px"
                    }), s.width = o + "px", s.height = o + "px", s["font-size"] = o + "px", s.transform = "none", s.margin = "0px auto", s["line-height"] = 19 * this.$scale + "px"; if (e.find("td[class='ico']").children("i").css(s), o = 14 * this.$scale, 1 === e.find(".span").length) e.find(".span").css({
                        "font-size": o + "px"
                    });
                else {
                    var d = t.width * this.$scale,
                        h = t.height * this.$scale;
                    if (s = {}, o < 12 && i) {
                        s["font-size"] = "14px", s.transform = "scale(" + this.$scale + ")";
                        var c = (d / this.$scale - 18 - (d - 18 * this.$scale)) / 2,
                            u = (h / this.$scale - h) / 2;
                        s.margin = -u + "px " + -c + "px"
            ...
            addNode: function (e, t, i, n, o) {
                if (!1 === i || "function" != typeof this.onItemAdd || !1 !== this.onItemAdd(e, "node", t)) {
                    ...
                    var r = t.marked ? " item_mark" : "",
                        s = this._getNodeCustom(t.type),
                        a = "";
                    ...
                    }), r && E.color.mark && this.$nodeDom[e].css({
                        "border-color": E.color.mark
            ...
            _addLineDom: function (e, t) {
                var i, n = this.$nodeData[t.from],
                    o = this.$nodeData[t.to];
                if (n && o && (i = t.type && "sl" !== t.type ? h(n, o, t.type, t.M, this.$scale) : c(n, o, this.$scale)))
                    if (this.$lineDom[e] = E.prototype._drawLine(e, i, t, this.$scale, t.type), this.$draw.appendChild(this.$lineDom[e]), "" === E.prototype.useSVG)
                        if (this.$lineDom[e].childNodes[1].innerHTML = t.name, "sl" !== t.type) {
                        ...
                        } else this.$lineDom[e].childNodes[1].style.left = ((i.end[0] - i.start[0]) * (i.end[0] > i.start[0] ? 1 : -1) - this.$lineDom[e].childNodes[1].offsetWidth) / 2 + 4;
                    else this.$lineDom[e].childNodes[2].textContent = t.name
            },
            addLine: function (e, t, i, n, o) {
                if (t.from !== t.to) {
                    var r = this.$nodeData[t.from],
                        s = this.$nodeData[t.to];
                    if (r && s && (!1 === i || "function" != typeof this.onItemAdd || !1 !== this.onItemAdd(e, "line", t))) {
                        for (var a in "undefined" == typeof t.dash && (t.dash = !1), this.$lineData)
                            if (t.noArrow) {
            ...
            resetLines: function (e, t) {
                for (var i in this.$lineData) {
                    ...
                    if (null != o)
                        if (this.$draw.removeChild(this.$lineDom[i]), this.$lineDom[i] = E.prototype._drawLine(i, n, this.$lineData[i], this.$scale, this.$lineData[i].type), this.$draw.appendChild(this.$lineDom[i]), "" === E.prototype.useSVG)
                            ...
                            } else this.$lineDom[i].childNodes[1].style.left = ((n.end[0] - n.start[0]) * (n.end[0] > n.start[0] ? 1 : -1) - this.$lineDom[i].childNodes[1].offsetWidth) / 2 + 4;
            ...
            setLineType: function (e, t, i) {
                ...
                if ("function" != typeof this.onLineSetType || !1 !== this.onLineSetType(e, t)) {
                    ...
                    var o, r = this.$lineData[e].from,
                        s = this.$lineData[e].to;
                    if ("sl" !== (this.$lineData[e].type = t)) i ? this.setLineM(e, i, !0, !1) : this.setLineM(e, (a = this.$nodeData[r], l = this.$nodeData[s], h || (h = 1), "lr" === (d = t) ? (a.left * h + a.width * h / 2 + l.left * h + l.width * h / 2) / 2 : "tb" === d ? (a.top * h + a.height * h / 2 + l.top * h + l.height * h / 2) / 2 : void 0), !0, !1);
                    else {
            ...
            setLineM: function (e, t, i, n, o) {
                ...
                var s = this.$lineData[e].from,
                    a = this.$lineData[e].to;
                this.$lineData[e].M = t;
            ...
            moveLinePoints: function (e, t, i, n) {
                if (t !== i && e && this.$lineData[e]) {
                    for (var o in null != t && "" !== t || (t = this.$lineData[e].from), null != i && "" !== i || (i = this.$lineData[e].to), this.$lineData)
                        if (t === this.$lineData[o].from && i === this.$lineData[o].to) return;
            ...
            setExtra: function (e) {
                if ("object" == typeof e)
                    for (var t in e) this.$extra[t] = e[t]
            },
            getExtra: function () {
                return this.$extra
            },
            loadData: function (e) {
                ...
                if (null != this.$group)
                    for (var n in e.areas) this.addArea(n, e.areas[n], !1, !0, !0);
                if (null != this.$paper)
                    for (var o in e.memos) this.addMemo(o, e.memos[o], !1, !0, !0);
                this.$deletedItem = {}, this.$extra = e.extra;
                var r = this._buildWorkSize();
                this.$workArea.css({
                    height: r.height + "px",
                    width: r.width + "px"
                }), this.$alignV && this.$alignV.css({
                    width: r.width + "px"
                }), this.$alignH && this.$alignH.css({
                    height: r.height + "px"
                }), "" === E.prototype.useSVG && (this.$draw.coordsize = r.width + "," + r.height), this.$navMap && this.refreshMap()
            },
            ...
            exportData: function () {
                ...
                if (null != this.$group)
                    for (var n in e.areas = {}, this.$areaData) e.areas[n] = JSON.parse(JSON.stringify(this.$areaData[n]));
                if (null != this.$paper)
                    for (var o in e.memos = {}, this.$memoData) e.memos[o] = JSON.parse(JSON.stringify(this.$memoData[o]));
            ...
            exportAlter: function () {
                ...
                if (null != this.$group)
                    for (var n in this.$areaData) this.$areaData[n].alt && (e.areas[n] = this.$areaData[n]);
                if (null != this.$paper)
                    for (var o in this.$memoData) this.$memoData[o].alt && (e.memos[o] = this.$memoData[o]);
            ...
            transNewId: function (e, t, i) {
                ...
                switch (i) {
                    ...
                    case "area":
                        if (this.$areaData[e])
                            for (var o in n = this.$areaData[e], delete this.$areaData[e], this.$areaData[t] = n, n = this.$areaDom[e].attr("id", t), delete this.$areaDom[e], this.$areaDom[t] = n, this.$nodeData) (n = this.$nodeData[o]).areaId === e && (this.$nodeData[o].areaId = t);
                        break;
                    case "memo":
            ...
            reinitSize: function (e, t) {
                var i = e || this.$bgDiv.width(),
                    n = t || this.$bgDiv.height();
                this.$bgDiv.css({
                    height: n + "px",
                    width: i + "px"
                });
                var o = 0,
                    r = 8;
                null != this.$head && (o = 26, r = 7), null != this.$tool && (this.$tool.css({
                    height: n - o - r + "px"
                }), i -= 31), i -= 9, n = n - o - (null != this.$head ? 5 : 8), this.$workArea.width() > i && (i = this.$workArea.width()), this.$workArea.height() > n && (n = this.$workArea.height()), this.$workArea.css({
                    height: n + "px",
                    width: i + "px"
                }), this.$alignV && this.$alignV.css({
                    width: i + "px"
                    ...
                    height: n + "px"
                }), "" === E.prototype.useSVG && (this.$draw.coordsize = i + "," + n), this.$navMap && this.refreshMap()
            },
            resetScale: function (r) {
                if (r ? r < .5 ? r = .5 : 4 < r && (r = 4) : r = 1, this.$scale !== r) {
                    var s = this.$scale / (this.$scale = r),
                        a = 0,
                        l = 0,
                        d = {};
                    this.blurItem();
                    ...
                    a = e.width + this.$workExtendStep, l = e.height + this.$workExtendStep, a < this.$workArea.parent().width() && (a = this.$workArea.parent().width()), l < this.$workArea.parent().height() && (l = this.$workArea.parent().height()), this.$workArea.css({
                        ...
                        height: l + "px"
                    }), "" === E.prototype.useSVG && (this.$draw.coordsize = a + "," + l);
                    var n = this,
                        h = -1 < navigator.userAgent.toLowerCase().indexOf("webkit");
                    this.$workArea.children(".GooFlow_item").each(function () {
                        var e = N(this),
                            t = n.getItemInfo(e.attr("id"), "node");
                        e.css({
                            left: t.left * r + "px",
                            top: t.top * r + "px"
                        }), n._scaleNode(e, t, h), a = t.width * r, l = t.height * r;
                        var i = e.hasClass("item_custom");
                        (e = e.children("table")).css({
                            width: a - (i ? 0 : 2) + "px",
                            height: l - (i ? 0 : 2) + "px"
                        })
                    });
    ...
    function (e, t) {
        ...
        "function" != typeof a.prototype._initGroup && (a.prototype.$areaData = {}, a.prototype.$areaCount = 0, a.prototype.$areaDom = {}, a.prototype._initGroup = function () {
            this.$group = d('<div class="GooFlow_work_group" style="width:100%;height:100%"></div>'), this.$workArea.prepend(this.$group), this.$editable && (this.$group.on("contextmenu", ".GooFlow_area", {
                inthis: this
            }, function (e) {
                var t = e.data.inthis;
                ...
                if ("group" === t.$nowType) {
                    ...
                    if ("function" != typeof t.onItemDbClick || !1 !== t.onItemDbClick(i.id, "area")) {
                        var n = e.target.innerHTML,
                            o = parseInt(i.style.left, 10) + 18,
                            r = parseInt(i.style.top, 10) + 1,
                            s = t.t;
...
var jsondata = { title: "newFlow_1", nodes: { demo_node_1: { name: "开始", left: 42, top: 38, type: "start round mix", width: 26, height: 26, alt: !0 }, demo_node_2: { name: "结束", left: 797, top: 42, type: "end round mix", width: 26, height: 26, alt: !0 }, demo_node_3: { name: "入职申请", left: 155, top: 39, type: "task", width: 104, height: 26, marked: !0, alt: !0, aaa: "AAA", ooo: { bbb: "BBB", text: "DDDD" }, ccc: { text: "CCCC" }, xxx: { hhh: "HHH" } }, demo_node_4: { name: "人力审批", left: 364, top: 42, type: "task", width: 104, height: 26, alt: !0, text: "请人力审批" }, demo_node_8: { name: "工资判断", left: 571, top: 43, type: "node", width: 104, height: 26, alt: !0 }, demo_node_9: { name: "经理终审", left: 559, top: 141, type: "task", width: 104, height: 26, color: "#f60", fontColor: "#fff" } }, lines: { demo_line_5: { type: "sl", from: "demo_node_3", to: "demo_node_4", name: "提交申请" }, demo_line_6: { type: "sl", from: "demo_node_1", to: "demo_node_3", name: "", dash: !0 }, demo_line_7: { type: "tb", M: 18.5, from: "demo_node_4", to: "demo_node_3", name: "不通过" }, demo_line_10: { type: "sl", from: "demo_node_4", to: "demo_node_8", name: "通过", dash: !0 }, demo_line_11: { type: "tb", M: 157, from: "demo_node_9", to: "demo_node_4", name: "不接受", dash: !0 }, demo_line_12: { type: "sl", from: "demo_node_8", to: "demo_node_9", name: "大于8000" }, demo_line_13: { type: "sl", from: "demo_node_8", to: "demo_node_2", name: "小于8000" }, demo_line_14: { marked: !0, type: "sl", from: "demo_node_9", to: "demo_node_2", name: "接受" } }, areas: { 1497581247380: { name: "审议会", left: 451, top: 110, color: "red", width: 226, height: 108, alt: !0 } }, extra: { targetNamespace: "textDemos", id: "xmlLoader", errorEvent: { type: "timeout" }, description: "一个GooFlow的示例" }, initNum: 16 };
! function (e, t) {
    "use strict";
    "undefined" != typeof define && define.amd ? define(["jquery", "GooFlow"], t) : "undefined" != typeof module && module.exports ? t(require("jquery"), require("GooFlow")) : t(e.$, e.GooFlow)
}("undefined" != typeof window ? window : this, function (e, n) {
    if (!n.prototype.print || "function" != typeof n.prototype.print) return function (f) {
        function m(e, t) {
            t && e.append(t.jquery ? t.clone() : t)
        }
        var v;
        f.fn.printThis = function (e) {
            v = f.extend({}, f.fn.printThis.defaults, e);
            var u = this instanceof jQuery ? this : f(this),
                t = "printThis-" + (new Date).getTime();
            if (window.location.hostname !== document.domain && navigator.userAgent.match(/msie/i)) {
                var i = 'javascript:document.write("<head><script>document.domain="' + document.domain + '";<\/script></head><body></body>")',
                    n = document.createElement("iframe");
                n.name = "printIframe", n.id = t, n.className = "MSIE", document.body.appendChild(n), n.src = i
            } else f("<iframe id='" + t + "' name='printIframe' />").appendTo("body");
            Goo.draw();
            var p = f("#" + t);
            v.debug || p.css({
                position: "absolute",
                ...
                var e, t, i, n;
                v.doctypeString && (e = p, t = v.doctypeString, (n = (i = (i = e.get(0)).contentWindow || i.contentDocument || i).document || i.contentDocument || i).open(), n.write(t), n.close());
                var o, r, s, a, l = p.contents(),
                    d = l.find("head"),
                    h = l.find("body"),
                    c = f("base");
                h.css({
                    ...
                    padding: "0",
                    background: "#fff"
                }), o = !0 === v.base && 0 < c.length ? c.attr("href") : "string" == typeof v.base ? v.base : document.location.protocol + "//" + document.location.host, d.append('<base href="' + o + '">'), f("link[rel=stylesheet]").each(function () {
                    var e = f(this).attr("href");
                    if (e) {
                        var t = f(this).attr("media") || "all";
                        d.append("<link type='text/css' rel='stylesheet' href='" + e + "' media='" + t + "'>")
                    }
                }), v.pageTitle && d.append("<title>" + v.pageTitle + "</title>"), m(h, v.header), r = h, s = v, a = u.clone(), s.printContainer ? a.appendTo(r) : a.each(function () {
                    f(this).children().appendTo(r)
                }), m(h, v.footer), setTimeout(function () {
                    p.hasClass("MSIE") ? (window.frames.printIframe.focus(), d.append("<script>  window.print(); <\/script>")) : document.queryCommandSupported("print") ? p[0].contentWindow.document.execCommand("print", !1, null) : (p[0].contentWindow.focus(), p[0].contentWindow.print()), v.debug || setTimeout(function () {
                        p.remove()
                    }, 1e3)
                }, v.printDelay)
            }, 333)
        }, f.fn.printThis.defaults = {
            debug: !1,
            printContainer: !0,
            pageTitle: "",
            printDelay: 333,
    ...
    }, 1e4), n.prototype.print = function (e) {
        var t = this._suitSize();
        e || (e = 1), t.width += 100, t.height += 100;
        var i = this.$workArea.clone();
        i.css({
            width: t.width + "px",
            height: t.height + "px"
        }), i.children(".GooFlow_work_paper").css({
            width: t.width + "px",
            height: t.height + "px"
        }), i.children(".GooFlow_work_group").css({
            width: t.width + "px",
            height: t.height + "px"
        }), i.children("svg").css({
            width: t.width + "px",
            height: t.height + "px"
        }), i.children(".GooFlow_work_vml").css({
            width: t.width + "px",
            height: t.height + "px"
        }), i = i.wrap('<div class="GooFlow GooFlow_work" style="width:' + t.width + "px;height:" + t.height + 'px; overflow:hidden"></div>').parent(), n.color.font && i.css("color", n.color.font), i.css({
